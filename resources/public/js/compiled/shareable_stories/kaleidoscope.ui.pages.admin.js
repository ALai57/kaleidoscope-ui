...
require("./kaleidoscope.ui.components.navbar.js");
require("./kaleidoscope.ui.components.button.js");
require("./kaleidoscope.ui.components.side_menu.js");
require("./kaleidoscope.ui.components.input_box.js");
require("./kaleidoscope.ui.components.thumbnail.js");
require("./kaleidoscope.ui.components.snackbar.js");
require("./kaleidoscope.ui.clients.keycloak.js");
require("./kaleidoscope.ui.components.modal.js");
require("./reagent_mui.components.js");
require("./re_frame.core.js");
require("./shadow.js.shim.module$keycloak_js.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.pages.admin.js");

goog.provide('kaleidoscope.ui.pages.admin');
goog.scope(function(){
  kaleidoscope.ui.pages.admin.goog$module$goog$object = goog.module.get('goog.object');
});
...
kaleidoscope.ui.pages.admin.success_QMARK_ = (function kaleidoscope$ui$pages$admin$success_QMARK_(p__22354){
var map__22355 = p__22354;
var map__22355__$1 = cljs.core.__destructure_map(map__22355);
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22355__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
...
kaleidoscope.ui.pages.admin.user_profile = (function kaleidoscope$ui$pages$admin$user_profile(p__22359){
var map__22360 = p__22359;
var map__22360__$1 = cljs.core.__destructure_map(map__22360);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22360__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var user_event_handlers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22360__$1,new cljs.core.Keyword(null,"user-event-handlers","user-event-handlers",-1831736477));
var notification_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22360__$1,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787));
var map__22361 = user;
var map__22361__$1 = cljs.core.__destructure_map(map__22361);
var avatar_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22361__$1,new cljs.core.Keyword(null,"avatar_url","avatar_url",1520721439));
var username = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22361__$1,new cljs.core.Keyword(null,"username","username",1605666410));
var given_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22361__$1,new cljs.core.Keyword(null,"given_name","given_name",2027851744));
var family_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22361__$1,new cljs.core.Keyword(null,"family_name","family_name",853479664));
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22361__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var map__22362 = user_event_handlers;
var map__22362__$1 = cljs.core.__destructure_map(map__22362);
var on_admin_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22362__$1,new cljs.core.Keyword(null,"on-admin-click","on-admin-click",-133363126));
var on_edit_profile_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22362__$1,new cljs.core.Keyword(null,"on-edit-profile-click","on-edit-profile-click",-1224328428));
var on_logout_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22362__$1,new cljs.core.Keyword(null,"on-logout-click","on-logout-click",1259146498));
var on_login_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22362__$1,new cljs.core.Keyword(null,"on-login-click","on-login-click",1291820089));
...
kaleidoscope.ui.pages.admin.login_ui = (function kaleidoscope$ui$pages$admin$login_ui(p__22365){
var map__22366 = p__22365;
var map__22366__$1 = cljs.core.__destructure_map(map__22366);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22366__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var user_event_handlers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22366__$1,new cljs.core.Keyword(null,"user-event-handlers","user-event-handlers",-1831736477));
var login_response = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22366__$1,new cljs.core.Keyword(null,"login-response","login-response",844783698));
var notification_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22366__$1,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787));
if(cljs.core.truth_(login_response)){
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"kaleidoscope.ui.pages.admin",null,123,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.navbar.nav_bar,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"user","user",1532431356),user], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [notifier,login_response], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.pages.admin.user_profile,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"user","user",1532431356),user,new cljs.core.Keyword(null,"user-event-handlers","user-event-handlers",-1831736477),user_event_handlers,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787),notification_type], null)], null)], null);
});
Object.defineProperty(module.exports, "authentication_failure", { enumerable: false, get: function() { return kaleidoscope.ui.pages.admin.authentication_failure; } });
Object.defineProperty(module.exports, "authentication_success", { enumerable: false, get: function() { return kaleidoscope.ui.pages.admin.authentication_success; } });
Object.defineProperty(module.exports, "success_QMARK_", { enumerable: false, get: function() { return kaleidoscope.ui.pages.admin.success_QMARK_; } });
Object.defineProperty(module.exports, "modal_notifier", { enumerable: false, get: function() { return kaleidoscope.ui.pages.admin.modal_notifier; } });
Object.defineProperty(module.exports, "snackbar_notifier", { enumerable: false, get: function() { return kaleidoscope.ui.pages.admin.snackbar_notifier; } });
Object.defineProperty(module.exports, "NOTIFIERS", { enumerable: false, get: function() { return kaleidoscope.ui.pages.admin.NOTIFIERS; } });
Object.defineProperty(module.exports, "user_profile", { enumerable: false, get: function() { return kaleidoscope.ui.pages.admin.user_profile; } });
Object.defineProperty(module.exports, "login_ui", { enumerable: false, get: function() { return kaleidoscope.ui.pages.admin.login_ui; } });
