...
var G__22410 = o;
reagent.impl.template.goog$module$goog$object.set(G__22410,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__22431__i < G__22431__a.length) {G__22431__a[G__22431__i] = arguments[G__22431__i + 0]; ++G__22431__i;}
  args = new cljs.core.IndexedSeq(G__22431__a,0,null);
} 
...
var G__22411 = props;
var G__22411__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22411,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22411);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22411__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22412 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22412,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22412;
}
})(),id_class);
...
var G__22413 = (cljs.core.count(argv) - first_child);
switch (G__22413) {
case (0):
...
var vec__22414 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22414,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22414,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22414,(2),null);
...
var temp__5808__auto___22434 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22434 == null)){
} else {
var key_22435 = temp__5808__auto___22434;
(jsprops.key = key_22435);
}
...
var temp__5808__auto___22436 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22436 == null)){
} else {
var key_22437 = temp__5808__auto___22436;
(jsprops.key = key_22437);
}
...
var temp__5808__auto___22438 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22438 == null)){
} else {
var key_22439 = temp__5808__auto___22438;
(jsprops.key = key_22439);
}
...
var temp__5808__auto___22440 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22440 == null)){
} else {
var key_22441 = temp__5808__auto___22440;
(jsprops.key = key_22441);
}
...
var temp__5808__auto___22442 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22442 == null)){
} else {
var key_22443 = temp__5808__auto___22442;
(jsprops.key = key_22443);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22417_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22417_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22418 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22418,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22418,(1),null);
...
break;
default:
var G__22445 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22446 = compiler;
v = G__22445;
compiler = G__22446;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22424 = (function (opts,id,fn_to_element,parse_fn,meta22425){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22424.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22426,meta22425__$1){
var self__ = this;
var _22426__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22424(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22425__$1));
}));

(reagent.impl.template.t_reagent$impl$template22424.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22426){
var self__ = this;
var _22426__$1 = this;
return self__.meta22425;
}));

(reagent.impl.template.t_reagent$impl$template22424.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22424.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22424.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22424.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22424.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22424.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22425","meta22425",1662227505,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22424.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22424.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22424");

(reagent.impl.template.t_reagent$impl$template22424.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template22424");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22424.
 */
reagent.impl.template.__GT_t_reagent$impl$template22424 = (function reagent$impl$template$__GT_t_reagent$impl$template22424(opts,id,fn_to_element,parse_fn,meta22425){
return (new reagent.impl.template.t_reagent$impl$template22424(opts,id,fn_to_element,parse_fn,meta22425));
});
...
return (new reagent.impl.template.t_reagent$impl$template22424(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
...
Object.defineProperty(module.exports, "t_reagent$impl$template22424", { enumerable: false, get: function() { return reagent.impl.template.t_reagent$impl$template22424; } });
...
Object.defineProperty(module.exports, "__GT_t_reagent$impl$template22424", { enumerable: false, get: function() { return reagent.impl.template.__GT_t_reagent$impl$template22424; } });
