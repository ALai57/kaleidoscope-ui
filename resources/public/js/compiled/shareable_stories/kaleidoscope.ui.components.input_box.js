...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.components.input_box.js");

goog.provide('kaleidoscope.ui.components.input_box');
kaleidoscope.ui.components.input_box.input_box = (function kaleidoscope$ui$components$input_box$input_box(p__26756){
var map__26757 = p__26756;
var map__26757__$1 = cljs.core.__destructure_map(map__26757);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26757__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var label_for = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26757__$1,new cljs.core.Keyword(null,"label-for","label-for",2108155322));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26757__$1,new cljs.core.Keyword(null,"value","value",305978217));
var read_only = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26757__$1,new cljs.core.Keyword(null,"read-only","read-only",-191706886),false);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dl.form-group","dl.form-group",24342720),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dt","dt",-368444759),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"for","for",-1323786319),label_for], null),label], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dd","dd",-1340437629),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.form-control","input.form-control",-1123419636),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"readOnly","readOnly",-1749118317),read_only,new cljs.core.Keyword(null,"value","value",305978217),value], null)], null)], null)], null);
});
Object.defineProperty(module.exports, "input_box", { enumerable: false, get: function() { return kaleidoscope.ui.components.input_box.input_box; } });
//# sourceMappingURL=kaleidoscope.ui.components.input_box.js.map
