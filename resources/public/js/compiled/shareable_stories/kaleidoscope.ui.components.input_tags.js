...
require("./shadow.js.shim.module$kaleidoscope_js$ui$components$InputTags.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.components.input_tags.js");

goog.provide('kaleidoscope.ui.components.input_tags');
kaleidoscope.ui.components.input_tags.input_tags = (function kaleidoscope$ui$components$input_tags$input_tags(p__22459){
var map__22460 = p__22459;
var map__22460__$1 = cljs.core.__destructure_map(map__22460);
var args = map__22460__$1;
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22460__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_add = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22460__$1,new cljs.core.Keyword(null,"on-add","on-add",-1283372042));
var on_remove = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22460__$1,new cljs.core.Keyword(null,"on-remove","on-remove",-268656163));
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22460__$1,new cljs.core.Keyword(null,"values","values",372645556));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f>","f>",1484564198),shadow.js.shim.module$kaleidoscope_js$ui$components$InputTags.InputTags,cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"options","options",99638489),options,new cljs.core.Keyword(null,"onAdd","onAdd",-1143701002),on_add,new cljs.core.Keyword(null,"onRemove","onRemove",867118207),on_remove,new cljs.core.Keyword(null,"vals","vals",768058733),values], null))], null);
});
Object.defineProperty(module.exports, "input_tags", { enumerable: false, get: function() { return kaleidoscope.ui.components.input_tags.input_tags; } });
