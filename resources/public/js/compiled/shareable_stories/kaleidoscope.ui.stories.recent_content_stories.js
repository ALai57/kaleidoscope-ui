...
require("./kaleidoscope.ui.stories.card_stories.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.stories.recent_content_stories.js");

goog.provide('kaleidoscope.ui.stories.recent_content_stories');
/**
 * Extracts inputs from existing card-stories so we can compose story pieces
 */
kaleidoscope.ui.stories.recent_content_stories.get_inputs = (function kaleidoscope$ui$stories$recent_content_stories$get_inputs(story){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([kaleidoscope.ui.stories.card_stories.example_data,cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(story,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0))], 0));
});
kaleidoscope.ui.stories.recent_content_stories.example_recent_content = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.stories.recent_content_stories.get_inputs(kaleidoscope.ui.stories.card_stories.Default),kaleidoscope.ui.stories.recent_content_stories.get_inputs(kaleidoscope.ui.stories.card_stories.Research),kaleidoscope.ui.stories.recent_content_stories.get_inputs(kaleidoscope.ui.stories.card_stories.Thoughts),kaleidoscope.ui.stories.recent_content_stories.get_inputs(kaleidoscope.ui.stories.card_stories.Data_Analysis)], null);
kaleidoscope.ui.stories.recent_content_stories.default$ = kaleidoscope.ui.stories.helper.__GT_default_story(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"Kaleidoscope/Articles/Recent Content",new cljs.core.Keyword(null,"component","component",1555936782),kaleidoscope.ui.components.article_cards.recent_content_cards,new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"recent-content","recent-content",-1697726460),kaleidoscope.ui.stories.recent_content_stories.example_recent_content], null)], null));
kaleidoscope.ui.stories.recent_content_stories.Default_recent_content = cljs.core.clj__GT_js(cljs.core.PersistentArrayMap.EMPTY);
Object.defineProperty(module.exports, "get_inputs", { enumerable: false, get: function() { return kaleidoscope.ui.stories.recent_content_stories.get_inputs; } });
Object.defineProperty(module.exports, "example_recent_content", { enumerable: false, get: function() { return kaleidoscope.ui.stories.recent_content_stories.example_recent_content; } });
Object.defineProperty(module.exports, "default", { enumerable: true, get: function() { return kaleidoscope.ui.stories.recent_content_stories.default$; } });
Object.defineProperty(module.exports, "Default_recent_content", { enumerable: true, get: function() { return kaleidoscope.ui.stories.recent_content_stories.Default_recent_content; } });
//# sourceMappingURL=kaleidoscope.ui.stories.recent_content_stories.js.map
