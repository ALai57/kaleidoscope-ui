...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.stories.colors.color_picker_stories.js");

goog.provide('kaleidoscope.ui.stories.colors.color_picker_stories');
kaleidoscope.ui.stories.colors.color_picker_stories.default$ = kaleidoscope.ui.stories.helper.__GT_default_story(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"title","title",636505583),"Basic Components/Color Picker",new cljs.core.Keyword(null,"component","component",1555936782),kaleidoscope.ui.components.colors.color_picker.color_picker,new cljs.core.Keyword(null,"parameters","parameters",-1229919748),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"docs","docs",-1974280502),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"description","description",-1428560544),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component","component",1555936782),"An RGB color picker component"], null)], null)], null),new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-color","initial-color",1935142727),"#DDDDDD",new cljs.core.Keyword(null,"collapsable","collapsable",-1764950761),true,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function() { 
var G__22824__delegate = function (args){
return shadow.js.shim.module$$storybook$addon_actions.action("on-change");
};
...
], null),new cljs.core.Keyword(null,"argTypes","argTypes",-1792314040),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"initial-color","initial-color",1935142727),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"The initial color to start with",new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),"#DDDDDD"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Callback when color is changed",new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),(function() { 
var G__22827__delegate = function (args){
return shadow.js.shim.module$$storybook$addon_actions.action("on-change");
};
...
while (G__22828__i < G__22828__a.length) {G__22828__a[G__22828__i] = arguments[G__22828__i + 0]; ++G__22828__i;}
  args = new cljs.core.IndexedSeq(G__22828__a,0,null);
} 
...
kaleidoscope.ui.stories.colors.color_picker_stories.Gray = cljs.core.clj__GT_js(cljs.core.PersistentArrayMap.EMPTY);
kaleidoscope.ui.stories.colors.color_picker_stories.Red = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"initial-color","initial-color",1935142727),"#FF0000"], null)], null));
Object.defineProperty(module.exports, "default", { enumerable: true, get: function() { return kaleidoscope.ui.stories.colors.color_picker_stories.default$; } });
Object.defineProperty(module.exports, "Gray", { enumerable: true, get: function() { return kaleidoscope.ui.stories.colors.color_picker_stories.Gray; } });
Object.defineProperty(module.exports, "Red", { enumerable: true, get: function() { return kaleidoscope.ui.stories.colors.color_picker_stories.Red; } });
//# sourceMappingURL=kaleidoscope.ui.stories.colors.color_picker_stories.js.map
