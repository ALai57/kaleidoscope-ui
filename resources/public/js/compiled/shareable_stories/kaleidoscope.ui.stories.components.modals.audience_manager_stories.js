...
require("./kaleidoscope.ui.components.modals.audience_manager.js");
require("./kaleidoscope.ui.components.button.js");
require("./kaleidoscope.ui.stories.components.groups.group_manager_stories.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.stories.components.modals.audience_manager_stories.js");

goog.provide('kaleidoscope.ui.stories.components.modals.audience_manager_stories');
kaleidoscope.ui.stories.components.modals.audience_manager_stories.groups = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__22859){
var map__22860 = p__22859;
var map__22860__$1 = cljs.core.__destructure_map(map__22860);
var group = map__22860__$1;
var display_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22860__$1,new cljs.core.Keyword(null,"display-name","display-name",694513143));
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(group,new cljs.core.Keyword(null,"title","title",636505583),display_name);
}),kaleidoscope.ui.stories.components.groups.group_manager_stories.groups);
kaleidoscope.ui.stories.components.modals.audience_manager_stories.default$ = kaleidoscope.ui.stories.helper.__GT_default_story(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"Modals/Audience Manager Modal",new cljs.core.Keyword(null,"component","component",1555936782),(function kaleidoscope$ui$stories$components$modals$audience_manager_stories$edit_audiences_modal(args){
...
}),new cljs.core.Keyword(null,"text","text",-1790561697),"Toggle modal"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.modals.audience_manager._edit_audiences_modal,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(args,new cljs.core.Keyword(null,"open?","open?",1238443125),cljs.core.deref(state),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-close","on-close",-761178394),(function (){
return cljs.core.reset_BANG_(state,false);
})], 0))], null)], null);
});
}),new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"open?","open?",1238443125),false,new cljs.core.Keyword(null,"audiences","audiences",860780056),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"article","article",-21685045),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"groups","groups",-136896102),kaleidoscope.ui.stories.components.modals.audience_manager_stories.groups], null)], null));
kaleidoscope.ui.stories.components.modals.audience_manager_stories.Basic_Edit_Audiences_Modal = cljs.core.clj__GT_js(cljs.core.PersistentArrayMap.EMPTY);
kaleidoscope.ui.stories.components.modals.audience_manager_stories.One_Tag_Selected = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"audiences","audiences",860780056),cljs.core.take.cljs$core$IFn$_invoke$arity$2((1),kaleidoscope.ui.stories.components.modals.audience_manager_stories.groups)], null)], null));
Object.defineProperty(module.exports, "groups", { enumerable: false, get: function() { return kaleidoscope.ui.stories.components.modals.audience_manager_stories.groups; } });
Object.defineProperty(module.exports, "default", { enumerable: true, get: function() { return kaleidoscope.ui.stories.components.modals.audience_manager_stories.default$; } });
Object.defineProperty(module.exports, "Basic_Edit_Audiences_Modal", { enumerable: true, get: function() { return kaleidoscope.ui.stories.components.modals.audience_manager_stories.Basic_Edit_Audiences_Modal; } });
Object.defineProperty(module.exports, "One_Tag_Selected", { enumerable: true, get: function() { return kaleidoscope.ui.stories.components.modals.audience_manager_stories.One_Tag_Selected; } });
//# sourceMappingURL=kaleidoscope.ui.stories.components.modals.audience_manager_stories.js.map
