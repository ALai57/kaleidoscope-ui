...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.stories.components.input_box_stories.js");

goog.provide('kaleidoscope.ui.stories.components.input_box_stories');
kaleidoscope.ui.stories.components.input_box_stories.default$ = kaleidoscope.ui.stories.helper.__GT_default_story(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"Basic Components/Input Box",new cljs.core.Keyword(null,"component","component",1555936782),kaleidoscope.ui.components.input_box.input_box,new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),"An Input Box",new cljs.core.Keyword(null,"label","label",1718410804),"Email",new cljs.core.Keyword(null,"label-for","label-for",2108155322),"email",new cljs.core.Keyword(null,"read-only","read-only",-191706886),false], null)], null));
kaleidoscope.ui.stories.components.input_box_stories.Editable_Input_Box = cljs.core.clj__GT_js(cljs.core.PersistentArrayMap.EMPTY);
kaleidoscope.ui.stories.components.input_box_stories.Read_Only_Input_Box = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"read-only","read-only",-191706886),true], null)], null));
Object.defineProperty(module.exports, "default", { enumerable: true, get: function() { return kaleidoscope.ui.stories.components.input_box_stories.default$; } });
Object.defineProperty(module.exports, "Editable_Input_Box", { enumerable: true, get: function() { return kaleidoscope.ui.stories.components.input_box_stories.Editable_Input_Box; } });
Object.defineProperty(module.exports, "Read_Only_Input_Box", { enumerable: true, get: function() { return kaleidoscope.ui.stories.components.input_box_stories.Read_Only_Input_Box; } });
//# sourceMappingURL=kaleidoscope.ui.stories.components.input_box_stories.js.map
