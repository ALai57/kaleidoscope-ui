...
require("./kaleidoscope.ui.pages.admin.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.stories.admin.user_profile_stories.js");

goog.provide('kaleidoscope.ui.stories.admin.user_profile_stories');
kaleidoscope.ui.stories.admin.user_profile_stories.example_user_data = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"given_name","given_name",2027851744),"Andrew",new cljs.core.Keyword(null,"family_name","family_name",853479664),"Lai",new cljs.core.Keyword(null,"avatar_url","avatar_url",1520721439),"",new cljs.core.Keyword(null,"username","username",1605666410),"andrewslai",new cljs.core.Keyword(null,"email","email",1415816706),"alai@not-a-real-email.com"], null);
kaleidoscope.ui.stories.admin.user_profile_stories.default$ = kaleidoscope.ui.stories.helper.__GT_default_story(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"Kaleidoscope/User Profile/User Login Widget",new cljs.core.Keyword(null,"component","component",1555936782),kaleidoscope.ui.pages.admin.user_profile,new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"user","user",1532431356),kaleidoscope.ui.stories.admin.user_profile_stories.example_user_data,new cljs.core.Keyword(null,"user-event-handlers","user-event-handlers",-1831736477),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"on-edit-profile-click","on-edit-profile-click",-1224328428),shadow.js.shim.module$$storybook$addon_actions.action("Clicked edit profile!"),new cljs.core.Keyword(null,"on-admin-click","on-admin-click",-133363126),shadow.js.shim.module$$storybook$addon_actions.action("Clicked admin!"),new cljs.core.Keyword(null,"on-login-click","on-login-click",1291820089),shadow.js.shim.module$$storybook$addon_actions.action("Clicked login!"),new cljs.core.Keyword(null,"on-logout-click","on-logout-click",1259146498),shadow.js.shim.module$$storybook$addon_actions.action("Clicked logout!")], null),new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787),new cljs.core.Keyword(null,"modal","modal",-1031880850)], null)], null));
kaleidoscope.ui.stories.admin.user_profile_stories.Logged_in = cljs.core.clj__GT_js(cljs.core.PersistentArrayMap.EMPTY);
kaleidoscope.ui.stories.admin.user_profile_stories.Logged_out = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"user","user",1532431356),null], null)], null));
Object.defineProperty(module.exports, "example_user_data", { enumerable: false, get: function() { return kaleidoscope.ui.stories.admin.user_profile_stories.example_user_data; } });
Object.defineProperty(module.exports, "default", { enumerable: true, get: function() { return kaleidoscope.ui.stories.admin.user_profile_stories.default$; } });
Object.defineProperty(module.exports, "Logged_in", { enumerable: true, get: function() { return kaleidoscope.ui.stories.admin.user_profile_stories.Logged_in; } });
Object.defineProperty(module.exports, "Logged_out", { enumerable: true, get: function() { return kaleidoscope.ui.stories.admin.user_profile_stories.Logged_out; } });
//# sourceMappingURL=kaleidoscope.ui.stories.admin.user_profile_stories.js.map
