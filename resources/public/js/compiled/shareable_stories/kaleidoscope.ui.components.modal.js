...
require("./reagent_mui.icons.close.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.components.modal.js");
...
kaleidoscope.ui.components.modal.modal_template = (function kaleidoscope$ui$components$modal$modal_template(p__22329){
var map__22330 = p__22329;
var map__22330__$1 = cljs.core.__destructure_map(map__22330);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22330__$1,new cljs.core.Keyword(null,"title","title",636505583));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22330__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var footer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22330__$1,new cljs.core.Keyword(null,"footer","footer",1606445390));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22330__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22330__$1,new cljs.core.Keyword(null,"level","level",1290497552),"info");
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.modal-content","div.modal-content",-83470844),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"border","border",1444987323),"none"], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.modal-header","div.modal-header",-799180845),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),cljs.core.get.cljs$core$IFn$_invoke$arity$2(kaleidoscope.ui.components.modal.COLORS,level)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4.modal-title","h4.modal-title",-572415885),title], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.close","button.close",-1545560743),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),on_close,new cljs.core.Keyword(null,"type","type",1174270348),"reset",new cljs.core.Keyword(null,"aria-label","aria-label",455891514),"Close"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.icons.close.close,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"close-button"], null)], null)], null)], null),(cljs.core.truth_(body)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.modal-body","div.modal-body",-2141892968),body], null):null)], null);
});
kaleidoscope.ui.components.modal.basic_modal = (function kaleidoscope$ui$components$modal$basic_modal(p__22331){
var map__22332 = p__22331;
var map__22332__$1 = cljs.core.__destructure_map(map__22332);
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22332__$1,new cljs.core.Keyword(null,"open?","open?",1238443125),true);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22332__$1,new cljs.core.Keyword(null,"title","title",636505583));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22332__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var footer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22332__$1,new cljs.core.Keyword(null,"footer","footer",1606445390));
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22332__$1,new cljs.core.Keyword(null,"level","level",1290497552),"info");
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22332__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
...
Object.defineProperty(module.exports, "COLORS", { enumerable: false, get: function() { return kaleidoscope.ui.components.modal.COLORS; } });
Object.defineProperty(module.exports, "MODAL_BACKGROUND", { enumerable: false, get: function() { return kaleidoscope.ui.components.modal.MODAL_BACKGROUND; } });
Object.defineProperty(module.exports, "modal_template", { enumerable: false, get: function() { return kaleidoscope.ui.components.modal.modal_template; } });
Object.defineProperty(module.exports, "basic_modal", { enumerable: false, get: function() { return kaleidoscope.ui.components.modal.basic_modal; } });
