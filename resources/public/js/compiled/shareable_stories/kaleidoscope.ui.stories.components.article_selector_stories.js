...
require("./kaleidoscope.ui.components.article_selector.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.stories.components.article_selector_stories.js");

goog.provide('kaleidoscope.ui.stories.components.article_selector_stories');
kaleidoscope.ui.stories.components.article_selector_stories.expand_button = (function kaleidoscope$ui$stories$components$article_selector_stories$expand_button(props){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.components.button,props,"Click me"], null);
});
kaleidoscope.ui.stories.components.article_selector_stories.default$ = kaleidoscope.ui.stories.helper.__GT_default_story(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"Kaleidoscope/Articles/Article Selector",new cljs.core.Keyword(null,"component","component",1555936782),kaleidoscope.ui.components.article_selector.article_selector,new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"branches","branches",-1240337268),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"branch-id","branch-id",-1859932285),(1),new cljs.core.Keyword(null,"branch-name","branch-name",2030030162),"main",new cljs.core.Keyword(null,"published-at","published-at",249684621),"2022-03-01T00:00:00Z",new cljs.core.Keyword(null,"article-id","article-id",793965839),(1),new cljs.core.Keyword(null,"author","author",2111686192),"Andrew Lai",new cljs.core.Keyword(null,"article-url","article-url",-1760823624),"my-first-article",new cljs.core.Keyword(null,"article-title","article-title",-1665332721),"My First Article",new cljs.core.Keyword(null,"article-tags","article-tags",1728644725),"thoughts"], null),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"branch-id","branch-id",-1859932285),(2),new cljs.core.Keyword(null,"branch-name","branch-name",2030030162),"main",new cljs.core.Keyword(null,"published-at","published-at",249684621),"2022-03-01T00:00:00Z",new cljs.core.Keyword(null,"article-id","article-id",793965839),(2),new cljs.core.Keyword(null,"author","author",2111686192),"Andrew Lai",new cljs.core.Keyword(null,"article-url","article-url",-1760823624),"my-second-article",new cljs.core.Keyword(null,"article-title","article-title",-1665332721),"My Second Article",new cljs.core.Keyword(null,"article-tags","article-tags",1728644725),"thoughts"], null),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"branch-id","branch-id",-1859932285),(3),new cljs.core.Keyword(null,"branch-name","branch-name",2030030162),"main",new cljs.core.Keyword(null,"published-at","published-at",249684621),"2022-03-01T00:00:00Z",new cljs.core.Keyword(null,"article-id","article-id",793965839),(3),new cljs.core.Keyword(null,"author","author",2111686192),"Andrew Lai",new cljs.core.Keyword(null,"article-url","article-url",-1760823624),"my-third-article",new cljs.core.Keyword(null,"article-title","article-title",-1665332721),"My Third Article",new cljs.core.Keyword(null,"article-tags","article-tags",1728644725),"thoughts"], null),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"branch-id","branch-id",-1859932285),(4),new cljs.core.Keyword(null,"branch-name","branch-name",2030030162),"main",new cljs.core.Keyword(null,"published-at","published-at",249684621),"2022-03-01T00:00:00Z",new cljs.core.Keyword(null,"article-id","article-id",793965839),(4),new cljs.core.Keyword(null,"author","author",2111686192),"Andrew Lai",new cljs.core.Keyword(null,"article-url","article-url",-1760823624),"neural-network-explanation",new cljs.core.Keyword(null,"article-title","article-title",-1665332721),"Neural Network Explanation",new cljs.core.Keyword(null,"article-tags","article-tags",1728644725),"thoughts"], null),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"branch-id","branch-id",-1859932285),(5),new cljs.core.Keyword(null,"branch-name","branch-name",2030030162),"test",new cljs.core.Keyword(null,"published-at","published-at",249684621),null,new cljs.core.Keyword(null,"article-id","article-id",793965839),(4),new cljs.core.Keyword(null,"author","author",2111686192),"Andrew Lai",new cljs.core.Keyword(null,"article-url","article-url",-1760823624),"neural-network-explanation",new cljs.core.Keyword(null,"article-title","article-title",-1665332721),"Neural Network Explanation",new cljs.core.Keyword(null,"article-tags","article-tags",1728644725),"thoughts"], null)], null),new cljs.core.Keyword(null,"expand-button","expand-button",990943226),(function (props){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.button.button,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([props,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),"Click me"], null)], 0))], null);
})], null)], null));
kaleidoscope.ui.stories.components.article_selector_stories.Default_Side_Menu = cljs.core.clj__GT_js(cljs.core.PersistentArrayMap.EMPTY);
Object.defineProperty(module.exports, "expand_button", { enumerable: false, get: function() { return kaleidoscope.ui.stories.components.article_selector_stories.expand_button; } });
Object.defineProperty(module.exports, "default", { enumerable: true, get: function() { return kaleidoscope.ui.stories.components.article_selector_stories.default$; } });
Object.defineProperty(module.exports, "Default_Side_Menu", { enumerable: true, get: function() { return kaleidoscope.ui.stories.components.article_selector_stories.Default_Side_Menu; } });
//# sourceMappingURL=kaleidoscope.ui.stories.components.article_selector_stories.js.map
