...
require("./reagent_mui.icons.manage_accounts.js");
require("./reagent_mui.components.js");
require("./reagent_mui.icons.menu.js");
require("./reagent_mui.icons.help.js");
require("./reagent_mui.icons.check_circle.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.components.navbar.js");

goog.provide('kaleidoscope.ui.components.navbar');
kaleidoscope.ui.components.navbar.nav_images_path = "images/nav-bar/";
...
kaleidoscope.ui.components.navbar.nav_icon = (function kaleidoscope$ui$components$navbar$nav_icon(route,src){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.zoom-icon","a.zoom-icon",1593109676),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["#/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(route)].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img.navbutton","img.navbutton",-213547787),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),src,new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-panel","set-active-panel",-965871124),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(route)], null));
})], null)], null)], null);
});
kaleidoscope.ui.components.navbar.img_path = (function kaleidoscope$ui$components$navbar$img_path(fname){
return [kaleidoscope.ui.components.navbar.nav_images_path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(fname)].join('');
});
kaleidoscope.ui.components.navbar.login_icon = (function kaleidoscope$ui$components$navbar$login_icon(route,src,user){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.zoom-icon","a.zoom-icon",1593109676),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["#/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(route)].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.components.badge,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"overlap","overlap",-1673335644),"circular",new cljs.core.Keyword(null,"class","class",-2030961996),"navbutton",new cljs.core.Keyword(null,"anchor-origin","anchor-origin",-1341383609),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vertical","vertical",718696748),"bottom",new cljs.core.Keyword(null,"horizontal","horizontal",2062109475),"right"], null),new cljs.core.Keyword(null,"badge-content","badge-content",1380607163),(cljs.core.truth_(user)?reagent.core.as_element.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.icons.check_circle.check_circle,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"large",new cljs.core.Keyword(null,"sx","sx",-403071592),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"padding-bottom","padding-bottom",-1899795591),"10px",new cljs.core.Keyword(null,"padding-right","padding-right",-1250249681),"10px",new cljs.core.Keyword(null,"color","color",1011675173),"green",new cljs.core.Keyword(null,"background-color","background-color",570434026),"#333333"], null)], null)], null)):reagent.core.as_element.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.icons.help.help,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"large",new cljs.core.Keyword(null,"sx","sx",-403071592),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"color","color",1011675173),"primary.main",new cljs.core.Keyword(null,"padding-bottom","padding-bottom",-1899795591),"10px",new cljs.core.Keyword(null,"padding-right","padding-right",-1250249681),"10px",new cljs.core.Keyword(null,"background-color","background-color",570434026),"#333333"], null)], null)], null)))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.components.avatar,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"alt","alt",-3214426),(cljs.core.truth_(user)?new cljs.core.Keyword(null,"firstName","firstName",-935151957).cljs$core$IFn$_invoke$arity$1(user):"Not logged in"),new cljs.core.Keyword(null,"class","class",-2030961996),"navbutton",new cljs.core.Keyword(null,"sx","sx",-403071592),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),"inherit",new cljs.core.Keyword(null,"height","height",1025178622),"inherit"], null),new cljs.core.Keyword(null,"img-props","img-props",1179566493),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"navbutton"], null),new cljs.core.Keyword(null,"src","src",-1651076051),src], null)], null)], null)], null);
});
kaleidoscope.ui.components.navbar.nav_bar = (function kaleidoscope$ui$components$navbar$nav_bar(p__22342){
var map__22343 = p__22342;
var map__22343__$1 = cljs.core.__destructure_map(map__22343);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22343__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var notification_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22343__$1,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#primary-nav","div#primary-nav",1654083432),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.zoom-icon","a.zoom-icon",1593109676),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"#/home",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"float","float",-1732389368),"left"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img.navbutton","img.navbutton",-213547787),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),kaleidoscope.ui.components.navbar.img_path("favicon.svg"),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-panel","set-active-panel",-965871124),new cljs.core.Keyword(null,"home","home",-74557309)], null));
})], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#secondary-nav","div#secondary-nav",1430404573),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.navbar.login_icon,"admin",kaleidoscope.ui.components.navbar.img_path("user.svg"),user], null),(cljs.core.truth_(user)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.navbar.nav_icon,"manager",kaleidoscope.ui.components.navbar.img_path("resources.svg")], null)], null):null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.navbar.nav_icon,"archive",kaleidoscope.ui.components.navbar.img_path("articles.svg")], null)], null)], null);
});
Object.defineProperty(module.exports, "nav_images_path", { enumerable: false, get: function() { return kaleidoscope.ui.components.navbar.nav_images_path; } });
Object.defineProperty(module.exports, "navigate_home_BANG_", { enumerable: false, get: function() { return kaleidoscope.ui.components.navbar.navigate_home_BANG_; } });
Object.defineProperty(module.exports, "nav_icon", { enumerable: false, get: function() { return kaleidoscope.ui.components.navbar.nav_icon; } });
Object.defineProperty(module.exports, "img_path", { enumerable: false, get: function() { return kaleidoscope.ui.components.navbar.img_path; } });
Object.defineProperty(module.exports, "login_icon", { enumerable: false, get: function() { return kaleidoscope.ui.components.navbar.login_icon; } });
Object.defineProperty(module.exports, "nav_bar", { enumerable: false, get: function() { return kaleidoscope.ui.components.navbar.nav_bar; } });
