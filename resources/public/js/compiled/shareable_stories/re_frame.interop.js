...
return [(function (){var pred__22558 = cljs.core.instance_QMARK_;
var expr__22559 = reactive_val;
if(cljs.core.truth_((pred__22558.cljs$core$IFn$_invoke$arity$2 ? pred__22558.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__22559) : pred__22558.call(null,reagent.ratom.RAtom,expr__22559)))){
return "ra";
} else {
if(cljs.core.truth_((pred__22558.cljs$core$IFn$_invoke$arity$2 ? pred__22558.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__22559) : pred__22558.call(null,reagent.ratom.RCursor,expr__22559)))){
return "rc";
} else {
if(cljs.core.truth_((pred__22558.cljs$core$IFn$_invoke$arity$2 ? pred__22558.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__22559) : pred__22558.call(null,reagent.ratom.Reaction,expr__22559)))){
return "rx";
} else {
if(cljs.core.truth_((pred__22558.cljs$core$IFn$_invoke$arity$2 ? pred__22558.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__22559) : pred__22558.call(null,reagent.ratom.Track,expr__22559)))){
return "tr";
} else {
return "other";
}
