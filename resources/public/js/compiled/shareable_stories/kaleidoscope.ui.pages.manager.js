...
require("./kaleidoscope.ui.components.manager.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.pages.manager.js");

goog.provide('kaleidoscope.ui.pages.manager');
kaleidoscope.ui.pages.manager._manager_page = (function kaleidoscope$ui$pages$manager$_manager_page(p__19205){
var map__19206 = p__19205;
var map__19206__$1 = cljs.core.__destructure_map(map__19206);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19206__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var groups = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19206__$1,new cljs.core.Keyword(null,"groups","groups",-136896102));
var notification_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19206__$1,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787));
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.navbar.nav_bar,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"user","user",1532431356),user,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787),notification_type], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#primary-content","div#primary-content",1350036775),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.manager.manager_cards], null)], null)], null);
});
kaleidoscope.ui.pages.manager.manager_page = (function kaleidoscope$ui$pages$manager$manager_page(p__19207){
var map__19208 = p__19207;
var map__19208__$1 = cljs.core.__destructure_map(map__19208);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19208__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var notification_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19208__$1,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.pages.manager._manager_page,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"user","user",1532431356),user,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787),notification_type], null)], null);
});
Object.defineProperty(module.exports, "_manager_page", { enumerable: false, get: function() { return kaleidoscope.ui.pages.manager._manager_page; } });
Object.defineProperty(module.exports, "manager_page", { enumerable: false, get: function() { return kaleidoscope.ui.pages.manager.manager_page; } });
//# sourceMappingURL=kaleidoscope.ui.pages.manager.js.map
