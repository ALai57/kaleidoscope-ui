...
require("./shadow.js.shim.module$$adobe$leonardo_contrast_colors.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.clients.leonardo.js");

goog.provide('kaleidoscope.ui.clients.leonardo');
kaleidoscope.ui.clients.leonardo.Color = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"string","string",-1989541586)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"color-keys","color-keys",-620002460),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),new cljs.core.Keyword(null,"string","string",-1989541586)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ratios","ratios",596401607),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),new cljs.core.Keyword(null,"number","number",1570378438)], null)], null)], null);
kaleidoscope.ui.clients.leonardo.Theme = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"colors","colors",1157174732),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),kaleidoscope.ui.clients.leonardo.Color], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"backgroundColor","backgroundColor",1738438491),kaleidoscope.ui.clients.leonardo.Color], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"lightness","lightness",-2040901930),new cljs.core.Keyword(null,"int","int",-1741416922)], null)], null);
kaleidoscope.ui.clients.leonardo.make_color = (function kaleidoscope$ui$clients$leonardo$make_color(color){
return (new shadow.js.shim.module$$adobe$leonardo_contrast_colors.Color(cljs.core.clj__GT_js(color)));
});
kaleidoscope.ui.clients.leonardo.make_background = (function kaleidoscope$ui$clients$leonardo$make_background(color){
return (new shadow.js.shim.module$$adobe$leonardo_contrast_colors.BackgroundColor(cljs.core.clj__GT_js(color)));
});
kaleidoscope.ui.clients.leonardo.make_theme = (function kaleidoscope$ui$clients$leonardo$make_theme(color){
return (new shadow.js.shim.module$$adobe$leonardo_contrast_colors.Theme(cljs.core.clj__GT_js(color)));
});
kaleidoscope.ui.clients.leonardo.GRAY = kaleidoscope.ui.clients.leonardo.make_color(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1843675177),"gray",new cljs.core.Keyword(null,"colorKeys","colorKeys",908311225),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["#bababa"], null),new cljs.core.Keyword(null,"ratios","ratios",596401607),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(2),(3),4.5,(8)], null)], null));
kaleidoscope.ui.clients.leonardo.BACKGROUND = kaleidoscope.ui.clients.leonardo.make_background(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1843675177),"bg",new cljs.core.Keyword(null,"colorKeys","colorKeys",908311225),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["#bababa"], null),new cljs.core.Keyword(null,"ratios","ratios",596401607),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(2),(3),4.5,(8)], null)], null));
kaleidoscope.ui.clients.leonardo.THEME = kaleidoscope.ui.clients.leonardo.make_theme(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"colors","colors",1157174732),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.clients.leonardo.GRAY], null),new cljs.core.Keyword(null,"backgroundColor","backgroundColor",1738438491),kaleidoscope.ui.clients.leonardo.BACKGROUND,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),(97)], null));
Object.defineProperty(module.exports, "Color", { enumerable: false, get: function() { return kaleidoscope.ui.clients.leonardo.Color; } });
Object.defineProperty(module.exports, "Theme", { enumerable: false, get: function() { return kaleidoscope.ui.clients.leonardo.Theme; } });
Object.defineProperty(module.exports, "make_color", { enumerable: false, get: function() { return kaleidoscope.ui.clients.leonardo.make_color; } });
Object.defineProperty(module.exports, "make_background", { enumerable: false, get: function() { return kaleidoscope.ui.clients.leonardo.make_background; } });
Object.defineProperty(module.exports, "make_theme", { enumerable: false, get: function() { return kaleidoscope.ui.clients.leonardo.make_theme; } });
Object.defineProperty(module.exports, "GRAY", { enumerable: false, get: function() { return kaleidoscope.ui.clients.leonardo.GRAY; } });
Object.defineProperty(module.exports, "BACKGROUND", { enumerable: false, get: function() { return kaleidoscope.ui.clients.leonardo.BACKGROUND; } });
Object.defineProperty(module.exports, "THEME", { enumerable: false, get: function() { return kaleidoscope.ui.clients.leonardo.THEME; } });
//# sourceMappingURL=kaleidoscope.ui.clients.leonardo.js.map
