...
require("./shadow.js.shim.module$pretty.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.components.slate.serialization.js");
...
return shadow.js.shim.module$$udecode$plate.serializeHtml(editor,({"nodes": editor.children, "preserveClassNames": ["slate-","slate-code_block","slate-code_line","language","prism-token","prism-","builtin","comment","function","keyword","number","operator","property","punctuation","selector","string","symbol","token"]}));
});
...
var editor = shadow.js.shim.module$$udecode$plate.useEditorState();
var html = kaleidoscope.ui.components.slate.serialization.serialize(editor);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"r>","r>",-1210228188),kaleidoscope.ui.components.slate.prism.HighlightHTML,({"Prism": kaleidoscope.ui.components.slate.prism.PRISM, "theme": kaleidoscope.ui.components.slate.prism.DRACULA, "code": shadow.js.shim.module$pretty(html), "language": "jsx"}),(function (args){
var map__19161 = kaleidoscope.ui.utils.core.clojurize(args);
var map__19161__$1 = cljs.core.__destructure_map(map__19161);
var clj_args = map__19161__$1;
var className = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19161__$1,new cljs.core.Keyword(null,"className","className",-1983287057));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19161__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var tokens = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19161__$1,new cljs.core.Keyword(null,"tokens","tokens",-818939304));
var getLineProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19161__$1,new cljs.core.Keyword(null,"getLineProps","getLineProps",1049981902));
var getTokenProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19161__$1,new cljs.core.Keyword(null,"getTokenProps","getTokenProps",-700661608));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(kaleidoscope.ui.utils.core.clojurize((function (){var G__19162 = ({"line": line});
return (getLineProps.cljs$core$IFn$_invoke$arity$1 ? getLineProps.cljs$core$IFn$_invoke$arity$1(G__19162) : getLineProps.call(null,G__19162));
...
Object.defineProperty(module.exports, "serialize", { enumerable: false, get: function() { return kaleidoscope.ui.components.slate.serialization.serialize; } });
Object.defineProperty(module.exports, "PrettyHtml", { enumerable: false, get: function() { return kaleidoscope.ui.components.slate.serialization.PrettyHtml; } });
