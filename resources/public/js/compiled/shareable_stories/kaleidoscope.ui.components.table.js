...
require("./reagent_mui.x.data_grid.js");
...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.components.table.js");

goog.provide('kaleidoscope.ui.components.table');
kaleidoscope.ui.components.table.USER_COLUMNS = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"field","field",-1302436500),new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"headerName","headerName",555903558),"User ID",new cljs.core.Keyword(null,"width","width",-384071477),(90)], null),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"field","field",-1302436500),new cljs.core.Keyword(null,"avatar","avatar",-1607499307),new cljs.core.Keyword(null,"headerName","headerName",555903558),"Avatar",new cljs.core.Keyword(null,"width","width",-384071477),(90)], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"field","field",-1302436500),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"headerName","headerName",555903558),"Name"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"field","field",-1302436500),new cljs.core.Keyword(null,"email","email",1415816706),new cljs.core.Keyword(null,"headerName","headerName",555903558),"Email"], null),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"field","field",-1302436500),new cljs.core.Keyword(null,"added-at","added-at",-352499434),new cljs.core.Keyword(null,"headerName","headerName",555903558),"Added at",new cljs.core.Keyword(null,"width","width",-384071477),(120)], null)], null);
kaleidoscope.ui.components.table.table = (function kaleidoscope$ui$components$table$table(p__28964){
var map__28965 = p__28964;
var map__28965__$1 = cljs.core.__destructure_map(map__28965);
var rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28965__$1,new cljs.core.Keyword(null,"rows","rows",850049680));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28965__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var toolbar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28965__$1,new cljs.core.Keyword(null,"toolbar","toolbar",-1172789065));
var max_width = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__28965__$1,new cljs.core.Keyword(null,"max-width","max-width",-1939924051),(650));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.components.box,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"height","height",1025178622),(400),new cljs.core.Keyword(null,"max-width","max-width",-1939924051),max_width], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.x.data_grid.data_grid,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"rows","rows",850049680),rows,new cljs.core.Keyword(null,"columns","columns",1998437288),columns,new cljs.core.Keyword(null,"page-size","page-size",223836073),(10),new cljs.core.Keyword(null,"row-height","row-height",527360749),(32),new cljs.core.Keyword(null,"rows-per-page-options","rows-per-page-options",-1981048019),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(10)], null),new cljs.core.Keyword(null,"disable-selection-on-click","disable-selection-on-click",2131101179),true], null)], null)], null);
});
Object.defineProperty(module.exports, "USER_COLUMNS", { enumerable: false, get: function() { return kaleidoscope.ui.components.table.USER_COLUMNS; } });
Object.defineProperty(module.exports, "table", { enumerable: false, get: function() { return kaleidoscope.ui.components.table.table; } });
//# sourceMappingURL=kaleidoscope.ui.components.table.js.map
