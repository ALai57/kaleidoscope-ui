...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.stories.components.side_menu_stories.js");

goog.provide('kaleidoscope.ui.stories.components.side_menu_stories');
kaleidoscope.ui.stories.components.side_menu_stories.expand_button = (function kaleidoscope$ui$stories$components$side_menu_stories$expand_button(props){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.components.button,props,"Toggle side window"], null);
});
kaleidoscope.ui.stories.components.side_menu_stories.default$ = kaleidoscope.ui.stories.helper.__GT_default_story(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"Basic Components/Side Menu",new cljs.core.Keyword(null,"component","component",1555936782),kaleidoscope.ui.components.side_menu.side_menu,new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"expand-button","expand-button",990943226),(function (props){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.button.button,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([props,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),"Toggle side window"], null)], 0))], null);
}),new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787),new cljs.core.Keyword(null,"modal","modal",-1031880850)], null)], null));
kaleidoscope.ui.stories.components.side_menu_stories.Default_Side_Menu = cljs.core.clj__GT_js(cljs.core.PersistentArrayMap.EMPTY);
Object.defineProperty(module.exports, "expand_button", { enumerable: false, get: function() { return kaleidoscope.ui.stories.components.side_menu_stories.expand_button; } });
Object.defineProperty(module.exports, "default", { enumerable: true, get: function() { return kaleidoscope.ui.stories.components.side_menu_stories.default$; } });
Object.defineProperty(module.exports, "Default_Side_Menu", { enumerable: true, get: function() { return kaleidoscope.ui.stories.components.side_menu_stories.Default_Side_Menu; } });
//# sourceMappingURL=kaleidoscope.ui.stories.components.side_menu_stories.js.map
