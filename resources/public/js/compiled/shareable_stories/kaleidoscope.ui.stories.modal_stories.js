...
$CLJS.SHADOW_ENV.setLoaded("kaleidoscope.ui.stories.modal_stories.js");

goog.provide('kaleidoscope.ui.stories.modal_stories');
kaleidoscope.ui.stories.modal_stories.default$ = kaleidoscope.ui.stories.helper.__GT_default_story(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"title","title",636505583),"Basic Components/Modal",new cljs.core.Keyword(null,"component","component",1555936782),(function kaleidoscope$ui$stories$modal_stories$basic_modal(args){
var state = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.button.button,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,cljs.core.not);

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Toggled modal to: ",cljs.core.deref(state)], 0));
}),new cljs.core.Keyword(null,"text","text",-1790561697),"Toggle modal"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.modal.basic_modal,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(args,new cljs.core.Keyword(null,"open?","open?",1238443125),cljs.core.deref(state),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-close","on-close",-761178394),(function (){
return cljs.core.reset_BANG_(state,false);
})], 0))], null)], null);
});
}),new cljs.core.Keyword(null,"argTypes","argTypes",-1792314040),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"open?","open?",1238443125),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"description","description",-1428560544),"Open the modal?",new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),false,new cljs.core.Keyword(null,"control","control",1892578036),"select",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null)], null),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"description","description",-1428560544),"Information Level",new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),"info",new cljs.core.Keyword(null,"control","control",1892578036),"select",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["info","success","warn","error"], null)], null),new cljs.core.Keyword(null,"title","title",636505583),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Modal's title",new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),"My title"], null),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Modal's body",new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),"Body text"], null),new cljs.core.Keyword(null,"on-close","on-close",-761178394),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"description","description",-1428560544),"What to do when Modal is closed"], null)], null),new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"open?","open?",1238443125),false,new cljs.core.Keyword(null,"title","title",636505583),"My Modal",new cljs.core.Keyword(null,"body","body",-2049205669),"Some body",new cljs.core.Keyword(null,"level","level",1290497552),"info"], null)], null));
kaleidoscope.ui.stories.modal_stories.Info_Modal = cljs.core.clj__GT_js(cljs.core.PersistentArrayMap.EMPTY);
kaleidoscope.ui.stories.modal_stories.Success_Modal = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"level","level",1290497552),"success"], null)], null));
kaleidoscope.ui.stories.modal_stories.Warn_Modal = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"level","level",1290497552),"warn"], null)], null));
kaleidoscope.ui.stories.modal_stories.Error_Modal = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"args","args",1315556576),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"level","level",1290497552),"error"], null)], null));
Object.defineProperty(module.exports, "default", { enumerable: true, get: function() { return kaleidoscope.ui.stories.modal_stories.default$; } });
Object.defineProperty(module.exports, "Info_Modal", { enumerable: true, get: function() { return kaleidoscope.ui.stories.modal_stories.Info_Modal; } });
Object.defineProperty(module.exports, "Success_Modal", { enumerable: true, get: function() { return kaleidoscope.ui.stories.modal_stories.Success_Modal; } });
Object.defineProperty(module.exports, "Warn_Modal", { enumerable: true, get: function() { return kaleidoscope.ui.stories.modal_stories.Warn_Modal; } });
Object.defineProperty(module.exports, "Error_Modal", { enumerable: true, get: function() { return kaleidoscope.ui.stories.modal_stories.Error_Modal; } });
//# sourceMappingURL=kaleidoscope.ui.stories.modal_stories.js.map
