...
void 0:null==(_subitems$get3=subitems.get(id))?void 0:_subitems$get3.disabled)||!1},items:subitemKeys,itemStringifier:id=>{var _subitems$get4,_subitems$get5,_subitems$get5$ref$cu;return(null==(_subitems$get4=subitems.get(id))?void 0:_subitems$get4.label)||(null==(_subitems$get5=subitems.get(id))?void 0:null==(_subitems$get5$ref$cu=_subitems$get5.ref.current)?void 0:_subitems$get5$ref$cu.innerText)},rootRef:parameters,onStateChange:stateChangeHandler,reducerActionContext:{listboxRef},selectionMode:"none",
...
{})=>{const rootProps=getRootProps(otherHandlers);return(0,_extends2.default)({},otherHandlers,rootProps,{role:"menu"})},highlightedValue,listboxRef:mergedListRef,menuItems:subitems,open}};var _extends2=_interopRequireDefault(require("module$node_modules$$babel$runtime$helpers$esm$extends")),React=function(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule)return obj;if(null===obj||"object"!==typeof obj&&"function"!==typeof obj)return{default:obj};if((nodeInterop=_getRequireWildcardCache(nodeInterop))&&
...
_utils=require("module$node_modules$$mui$utils$esm$index"),_useList=_interopRequireDefault(require("module$node_modules$$mui$base$useList$index")),_useCompound=require("module$node_modules$$mui$base$utils$useCompound"),_menuReducer=_interopRequireDefault(require("module$node_modules$$mui$base$useMenu$menuReducer"))}
//# sourceMappingURL=module$node_modules$$mui$base$useMenu$useMenu.js.map
