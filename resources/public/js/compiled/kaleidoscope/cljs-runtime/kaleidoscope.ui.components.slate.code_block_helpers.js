...
var G__16543 = html_element;
var G__16543__$1 = (((G__16543 == null))?null:G__16543.className);
var G__16543__$2 = (((G__16543__$1 == null))?null:G__16543__$1.match(/language-(?<language>\w+)/));
var G__16543__$3 = (((G__16543__$2 == null))?null:G__16543__$2.groups);
if((G__16543__$3 == null)){
return null;
} else {
return G__16543__$3.language;
}
});
...
var map__16544 = kaleidoscope.ui.utils.core.clojurize(args);
var map__16544__$1 = cljs.core.__destructure_map(map__16544);
var clj_args = map__16544__$1;
var className = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16544__$1,new cljs.core.Keyword(null,"className","className",-1983287057));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16544__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var tokens = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16544__$1,new cljs.core.Keyword(null,"tokens","tokens",-818939304));
var getTokenProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16544__$1,new cljs.core.Keyword(null,"getTokenProps","getTokenProps",-700661608));
var getLineProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16544__$1,new cljs.core.Keyword(null,"getLineProps","getLineProps",1049981902));
var lines = tokens;
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(kaleidoscope.ui.utils.core.clojurize((function (){var G__16545 = ({"line": tokens__$1});
return (getLineProps.cljs$core$IFn$_invoke$arity$1 ? getLineProps.cljs$core$IFn$_invoke$arity$1(G__16545) : getLineProps.call(null,G__16545));
...
kaleidoscope.ui.components.slate.code_block_helpers.CodeBlockSelectElement = (function kaleidoscope$ui$components$slate$code_block_helpers$CodeBlockSelectElement(p__16546){
var map__16547 = p__16546;
var map__16547__$1 = cljs.core.__destructure_map(map__16547);
var props = map__16547__$1;
var lang = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16547__$1,new cljs.core.Keyword(null,"lang","lang",-1819677104));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16547__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var G__16548_16561 = kaleidoscope.ui.utils.events.event_value(e);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__16548_16561) : on_change.call(null,G__16548_16561));

return cljs.core.reset_BANG_(v,kaleidoscope.ui.utils.events.event_value(e));
}),new cljs.core.Keyword(null,"contentEditable","contentEditable",-823191689),false], null),(function (){var iter__5523__auto__ = (function kaleidoscope$ui$components$slate$code_block_helpers$CodeBlockSelectElement_$_iter__16549(s__16550){
return (new cljs.core.LazySeq(null,(function (){
var s__16550__$1 = s__16550;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__16550__$1);
if(temp__5804__auto__){
var s__16550__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__16550__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__16550__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__16552 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__16551 = (0);
while(true){
if((i__16551 < size__5522__auto__)){
var vec__16553 = cljs.core._nth(c__5521__auto__,i__16551);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16553,(0),null);
var v__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16553,(1),null);
cljs.core.chunk_append(b__16552,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.name(k),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(k)], null),v__$1], null));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16552),kaleidoscope$ui$components$slate$code_block_helpers$CodeBlockSelectElement_$_iter__16549(cljs.core.chunk_rest(s__16550__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16552),null);
}
} else {
var vec__16556 = cljs.core.first(s__16550__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16556,(0),null);
var v__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16556,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.name(k),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(k)], null),v__$1], null),kaleidoscope$ui$components$slate$code_block_helpers$CodeBlockSelectElement_$_iter__16549(cljs.core.rest(s__16550__$2)));
}
} else {
return null;
}
...
kaleidoscope.ui.components.slate.code_block_helpers.CustomCodeBlock = (function kaleidoscope$ui$components$slate$code_block_helpers$CustomCodeBlock(p__16559){
var map__16560 = p__16559;
var map__16560__$1 = cljs.core.__destructure_map(map__16560);
var props = map__16560__$1;
var attributes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16560__$1,new cljs.core.Keyword(null,"attributes","attributes",-74013604));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16560__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var nodeProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16560__$1,new cljs.core.Keyword(null,"nodeProps","nodeProps",1793008770));
var element = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16560__$1,new cljs.core.Keyword(null,"element","element",1974019749));
var editor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16560__$1,new cljs.core.Keyword(null,"editor","editor",-989377770));
console.log(props);
