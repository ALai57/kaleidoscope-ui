...
kaleidoscope.ui.components.colors.color_picker.Paper = (function (){var G__18879 = (function (obj){
...
var fexpr__18878 = module$node_modules$$mui$material$styles$index.styled(module$node_modules$$mui$material$Paper$index.default);
return (fexpr__18878.cljs$core$IFn$_invoke$arity$1 ? fexpr__18878.cljs$core$IFn$_invoke$arity$1(G__18879) : fexpr__18878.call(null,G__18879));
})();
kaleidoscope.ui.components.colors.color_picker.basic_color_picker = (function kaleidoscope$ui$components$colors$color_picker$basic_color_picker(p__18880){
var map__18881 = p__18880;
var map__18881__$1 = cljs.core.__destructure_map(map__18881);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18881__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18881__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
kaleidoscope.ui.components.colors.color_picker.color_picker = (function kaleidoscope$ui$components$colors$color_picker$color_picker(p__18882){
var map__18883 = p__18882;
var map__18883__$1 = cljs.core.__destructure_map(map__18883);
var initial_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18883__$1,new cljs.core.Keyword(null,"initial-color","initial-color",1935142727));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18883__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var collapsable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18883__$1,new cljs.core.Keyword(null,"collapsable","collapsable",-1764950761));
...
})], null)], null),(cljs.core.truth_(cljs.core.deref(open_QMARK_))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var G__18884 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(collapsable)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__18884,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"position","position",-2011731912),"absolute",new cljs.core.Keyword(null,"z-index","z-index",1892827090),(1000)], null)], null)], 0));
} else {
return G__18884;
}
