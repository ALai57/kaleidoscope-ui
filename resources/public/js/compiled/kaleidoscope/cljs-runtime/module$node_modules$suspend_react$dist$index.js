...
}Object.defineProperty(exports,"__esModule",{value:!0});exports.suspend=exports.preload=exports.peek=exports.clear=void 0;const globalCache=[];exports.suspend=(fn,keys,config)=>query(fn,keys,!1,config);exports.preload=(fn,keys,config)=>void query(fn,keys,!0,config);exports.peek=keys=>{var _globalCache$find;return null==(_globalCache$find=globalCache.find(entry=>shallowEqualArrays(keys,entry.keys,entry.equal)))?void 0:_globalCache$find.response};exports.clear=keys=>{if(void 0===keys||0===keys.length)globalCache.splice(0,
globalCache.length);else{var entry$jscomp$0=globalCache.find(entry=>shallowEqualArrays(keys,entry.keys,entry.equal));entry$jscomp$0&&(entry$jscomp$0=globalCache.indexOf(entry$jscomp$0),-1!==entry$jscomp$0&&globalCache.splice(entry$jscomp$0,1))}}}
//# sourceMappingURL=module$node_modules$suspend_react$dist$index.js.map
