...
try{var G__43816 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(dom);
...
break;
case "element":
if(cljs.core.truth_((function (){var G__43817 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(dom);
return (hickory.utils.void_element.cljs$core$IFn$_invoke$arity$1 ? hickory.utils.void_element.cljs$core$IFn$_invoke$arity$1(G__43817) : hickory.utils.void_element.call(null,G__43817));
})())){
...
if(cljs.core.truth_((function (){var G__43819 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(dom);
return (hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1 ? hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1(G__43819) : hickory.utils.unescapable_content.call(null,G__43819));
})())){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43816__$1)].join('')));

}
}catch (e43815){if((e43815 instanceof Error)){
var e = e43815;
...
var attrs_str = clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43823_SHARP_){
return (!(cljs.core.empty_QMARK_(p1__43823_SHARP_)));
}),(function (){var iter__5523__auto__ = (function hickory$render$render_hiccup_attrs_$_iter__43827(s__43828){
return (new cljs.core.LazySeq(null,(function (){
var s__43828__$1 = s__43828;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__43828__$1);
if(temp__5804__auto__){
var s__43828__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43828__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__43828__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__43830 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__43829 = (0);
while(true){
if((i__43829 < size__5522__auto__)){
var vec__43832 = cljs.core._nth(c__5521__auto__,i__43829);
...
cljs.core.chunk_append(b__43830,((v === true)?cljs.core.name(k):(((v == null))?"":[cljs.core.name(k),"=","\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(hickory.utils.html_escape(v)),"\""].join('')
)));

var G__43850 = (i__43829 + (1));
i__43829 = G__43850;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43830),hickory$render$render_hiccup_attrs_$_iter__43827(cljs.core.chunk_rest(s__43828__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43830),null);
}
} else {
var vec__43840 = cljs.core.first(s__43828__$2);
...
)),hickory$render$render_hiccup_attrs_$_iter__43827(cljs.core.rest(s__43828__$2)));
}
} else {
return null;
}
...
var tag = first__43845;
var first__43845__$1 = cljs.core.first(seq__43844__$1);
var seq__43844__$2 = cljs.core.next(seq__43844__$1);
var attrs = first__43845__$1;
var content = seq__43844__$2;
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43846_SHARP_){
return hickory.render.render_hiccup_form(hickory.hiccup_utils.normalize_form(p1__43846_SHARP_));
}),hiccup_forms));
});
