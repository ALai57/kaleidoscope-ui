...
var vec__20391 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20391,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20391,(1),null);
...
return cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__20406_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__20406_SHARP_),"null");
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__20408 = in$;
...
spec_tools.openapi.core.extract_object_param = (function spec_tools$openapi$core$extract_object_param(in$,p__20409){
var map__20410 = p__20409;
var map__20410__$1 = cljs.core.__destructure_map(map__20410);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20410__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20410__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__20411){
var vec__20412 = p__20411;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20412,(0),null);
var map__20415 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20412,(1),null);
var map__20415__$1 = cljs.core.__destructure_map(map__20415);
var schema = map__20415__$1;
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20415__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__20416 = in$;
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__20418 = cljs.core.get_global_hierarchy;
return (fexpr__20418.cljs$core$IFn$_invoke$arity$0 ? fexpr__20418.cljs$core$IFn$_invoke$arity$0() : fexpr__20418.call(null));
})());
...
})(),(function (){var iter__5523__auto__ = (function spec_tools$openapi$core$iter__20419(s__20420){
return (new cljs.core.LazySeq(null,(function (){
var s__20420__$1 = s__20420;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__20420__$1);
if(temp__5804__auto__){
var s__20420__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20420__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__20420__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__20422 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__20421 = (0);
while(true){
if((i__20421 < size__5522__auto__)){
var vec__20424 = cljs.core._nth(c__5521__auto__,i__20421);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20424,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20424,(1),null);
cljs.core.chunk_append(b__20422,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]));

var G__20463 = (i__20421 + (1));
i__20421 = G__20463;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20422),spec_tools$openapi$core$iter__20419(cljs.core.chunk_rest(s__20420__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20422),null);
}
} else {
var vec__20427 = cljs.core.first(s__20420__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20427,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20427,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]),spec_tools$openapi$core$iter__20419(cljs.core.rest(s__20420__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5523__auto__ = (function spec_tools$openapi$core$iter__20430(s__20431){
return (new cljs.core.LazySeq(null,(function (){
var s__20431__$1 = s__20431;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__20431__$1);
if(temp__5804__auto__){
var s__20431__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20431__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__20431__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__20433 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__20432 = (0);
while(true){
if((i__20432 < size__5522__auto__)){
var vec__20434 = cljs.core._nth(c__5521__auto__,i__20432);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20434,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20434,(1),null);
cljs.core.chunk_append(b__20433,cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]));

var G__20464 = (i__20432 + (1));
i__20432 = G__20464;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20433),spec_tools$openapi$core$iter__20430(cljs.core.chunk_rest(s__20431__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20433),null);
}
} else {
var vec__20437 = cljs.core.first(s__20431__$2);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20437,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20437,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]),spec_tools$openapi$core$iter__20430(cljs.core.rest(s__20431__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__20440){
var vec__20441 = p__20440;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20441,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20441,(1),null);
return spec_tools.openapi.core.extract_parameter(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__20444,p){
var vec__20445 = p__20444;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20445,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20445,(1),null);
var acc__$1 = vec__20445;
...
})(),(function (){var iter__5523__auto__ = (function spec_tools$openapi$core$iter__20448(s__20449){
return (new cljs.core.LazySeq(null,(function (){
var s__20449__$1 = s__20449;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__20449__$1);
if(temp__5804__auto__){
var s__20449__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20449__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__20449__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__20451 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__20450 = (0);
while(true){
if((i__20450 < size__5522__auto__)){
var vec__20452 = cljs.core._nth(c__5521__auto__,i__20450);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20452,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20452,(1),null);
cljs.core.chunk_append(b__20451,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]));

var G__20465 = (i__20450 + (1));
i__20450 = G__20465;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20451),spec_tools$openapi$core$iter__20448(cljs.core.chunk_rest(s__20449__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20451),null);
}
} else {
var vec__20455 = cljs.core.first(s__20449__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20455,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20455,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]),spec_tools$openapi$core$iter__20448(cljs.core.rest(s__20449__$2)));
}
} else {
return null;
}
