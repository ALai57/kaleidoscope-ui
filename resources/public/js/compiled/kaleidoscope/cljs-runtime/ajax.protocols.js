...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_40038 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_40038(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_40042 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_40042(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_40043 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_40043(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_40047 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_40047(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_40048 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_40048(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_40049 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_40049(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_40052 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_40052(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_40053 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_40053(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_40058 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_40058(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_40059 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_40059(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k40004,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k40004,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__40009){
var vec__40010 = p__40009;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40010,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40010,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__40003){
var self__ = this;
var G__40003__$1 = this;
return (new cljs.core.RecordIter((0),G__40003__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this40005,other40006){
var self__ = this;
var this40005__$1 = this;
return (((!((other40006 == null)))) && ((((this40005__$1.constructor === other40006.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40005__$1.status,other40006.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40005__$1.body,other40006.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40005__$1.status_text,other40006.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40005__$1.headers,other40006.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40005__$1.was_aborted,other40006.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40005__$1.__extmap,other40006.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k40004){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k40004);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__40003){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__40023 = cljs.core.keyword_identical_QMARK_;
var expr__40024 = k__5352__auto__;
if(cljs.core.truth_((pred__40023.cljs$core$IFn$_invoke$arity$2 ? pred__40023.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__40024) : pred__40023.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__40024)))){
return (new ajax.protocols.Response(G__40003,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__40023.cljs$core$IFn$_invoke$arity$2 ? pred__40023.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__40024) : pred__40023.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__40024)))){
return (new ajax.protocols.Response(self__.status,G__40003,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__40023.cljs$core$IFn$_invoke$arity$2 ? pred__40023.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__40024) : pred__40023.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__40024)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__40003,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__40023.cljs$core$IFn$_invoke$arity$2 ? pred__40023.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__40024) : pred__40023.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__40024)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__40003,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__40023.cljs$core$IFn$_invoke$arity$2 ? pred__40023.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__40024) : pred__40023.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__40024)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__40003,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__40003),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__40003){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__40003,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__40007){
var extmap__5385__auto__ = (function (){var G__40026 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__40007,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__40007)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__40026);
} else {
return G__40026;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__40007),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__40007),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__40007),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__40007),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__40007),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
