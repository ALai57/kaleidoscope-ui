...
return cljs.core.every_QMARK_((function (p1__43793_SHARP_){
return ((0) < cljs.core.count(p1__43793_SHARP_));
...
if((cutoff === (-1))){
var G__43805 = next_dot;
var G__43806 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(classes,tag_elem__$1.substring((curr_dot + (1))));
curr_dot = G__43805;
classes = G__43806;
continue;
} else {
var G__43807 = next_dot;
var G__43808 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(classes,tag_elem__$1.substring((curr_dot + (1)),cutoff));
curr_dot = G__43807;
classes = G__43808;
continue;
}
...
var G__43809 = cljs.core.next(remaining_content);
var G__43810 = (function (){var remaining_seq = cljs.core.first(remaining_content);
var result__$1 = result;
while(true){
if((remaining_seq == null)){
return result__$1;
} else {
var G__43811 = cljs.core.next(remaining_seq);
var G__43812 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(result__$1,cljs.core.first(remaining_seq));
remaining_seq = G__43811;
result__$1 = G__43812;
continue;
}
break;
...
remaining_content = G__43809;
result = G__43810;
continue;
} else {
var G__43813 = cljs.core.next(remaining_content);
var G__43814 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(result,cljs.core.first(remaining_content));
remaining_content = G__43813;
result = G__43814;
continue;
}
}
...
var tag_elem = first__43796;
var content = seq__43795__$1;
...
var vec__43797 = ((cljs.core.map_QMARK_(cljs.core.first(content)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(content),cljs.core.rest(content)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,content], null));
var map_attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43797,(0),null);
var content__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43797,(1),null);
...
var vec__43801 = hickory.hiccup_utils.normalize_element(form);
...
var tag = first__43803;
var first__43803__$1 = cljs.core.first(seq__43802__$1);
var seq__43802__$2 = cljs.core.next(seq__43802__$1);
var attrs = first__43803__$1;
var contents = seq__43802__$2;
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(cljs.core.vector,tag,attrs,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43800_SHARP_){
if(cljs.core.vector_QMARK_(p1__43800_SHARP_)){
return (hickory.hiccup_utils.normalize_form.cljs$core$IFn$_invoke$arity$1 ? hickory.hiccup_utils.normalize_form.cljs$core$IFn$_invoke$arity$1(p1__43800_SHARP_) : hickory.hiccup_utils.normalize_form.call(null,p1__43800_SHARP_));
} else {
