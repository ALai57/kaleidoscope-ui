...
var action__17698__auto___20145 = (function (params__17699__auto__){
if(cljs.core.map_QMARK_(params__17699__auto__)){
var map__20132 = params__17699__auto__;
...
if(cljs.core.vector_QMARK_(params__17699__auto__)){
var vec__20133 = params__17699__auto__;
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-panel","set-active-panel",-965871124),new cljs.core.Keyword(null,"home","home",-74557309)], null));
} else {
return null;
}
...
secretary.core.add_route_BANG_("/",action__17698__auto___20145);

var action__17698__auto___20146 = (function (params__17699__auto__){
if(cljs.core.map_QMARK_(params__17699__auto__)){
var map__20136 = params__17699__auto__;
var map__20136__$1 = cljs.core.__destructure_map(map__20136);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20136__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
if(cljs.core.vector_QMARK_(params__17699__auto__)){
var vec__20137 = params__17699__auto__;
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20137,(0),null);
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-panel","set-active-panel",-965871124),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(path)], null));
} else {
return null;
}
...
secretary.core.add_route_BANG_("/:path",action__17698__auto___20146);

var action__17698__auto___20147 = (function (params__17699__auto__){
if(cljs.core.map_QMARK_(params__17699__auto__)){
var map__20140 = params__17699__auto__;
var map__20140__$1 = cljs.core.__destructure_map(map__20140);
var content_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20140__$1,new cljs.core.Keyword(null,"content-name","content-name",1587146818));
...
if(cljs.core.vector_QMARK_(params__17699__auto__)){
var vec__20141 = params__17699__auto__;
var content_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20141,(0),null);
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-panel","set-active-panel",-965871124),new cljs.core.Keyword(null,"content","content",15833224)], null));
...
secretary.core.add_route_BANG_("/content/:content-name",action__17698__auto___20147);

kaleidoscope.ui.core.HISTORY = (new goog.History());
var G__20144_20148 = kaleidoscope.ui.core.HISTORY;
goog.events.listen(G__20144_20148,goog.history.EventType.NAVIGATE,(function (event){
return secretary.core.dispatch_BANG_(event.token);
}));

G__20144_20148.setEnabled(true);
