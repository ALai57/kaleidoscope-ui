...
var i_31119 = (0);
while(true){
if((i_31119 < arr.length)){
(arr[i_31119] = null);

var G__31120 = (i_31119 + (1));
i_31119 = G__31120;
continue;
} else {
}
...
var i_31129 = (self__.level + (1));
while(true){
if((i_31129 <= (new_level + (1)))){
(update[i_31129] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_31132 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31132[i]));
} else {
x__$2.forward.push((((i < links_31132.length))?(links_31132[i]):null));
}

if((i < links_31132.length)){
(links_31132[i] = x__$2);
} else {
links_31132.push(x__$2);
}
...
var i_31135 = (0);
while(true){
if((i_31135 <= self__.level)){
var links_31136 = (update[i_31135]).forward;
if((x__$1 === (((i_31135 < links_31136.length))?(links_31136[i_31135]):null))){
(links_31136[i_31135] = (x__$1.forward[i_31135]));

var G__31137 = (i_31135 + (1));
i_31135 = G__31137;
continue;
} else {
var G__31138 = (i_31135 + (1));
i_31135 = G__31138;
continue;
}
} else {
...
var G__31141 = nx;
var G__31142 = (level__$1 - (1));
x = G__31141;
level__$1 = G__31142;
continue;
} else {
var G__31143 = x;
var G__31144 = (level__$1 - (1));
x = G__31143;
level__$1 = G__31144;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__31146 = nx;
var G__31147 = (level__$1 - (1));
x = G__31146;
level__$1 = G__31147;
continue;
} else {
var G__31148 = x;
var G__31149 = (level__$1 - (1));
x = G__31148;
level__$1 = G__31149;
continue;
}
