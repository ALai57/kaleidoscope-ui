...
var _PERCENT_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.string.trim,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__20461_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__20461_SHARP_,/:/);
...
var _PERCENT_ = cljs.core.zipmap(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__20462_SHARP_,p2__20463_SHARP_){
if(cljs.core.even_QMARK_(p1__20462_SHARP_)){
return p2__20463_SHARP_;
} else {
return null;
}
}),tokens),cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__20464_SHARP_,p2__20465_SHARP_){
if(cljs.core.odd_QMARK_(p1__20464_SHARP_)){
return p2__20465_SHARP_;
} else {
return null;
}
}),tokens));
...
document.getElementById("primary-content").appendChild((function (){var G__20466 = document.createElement("script");
G__20466.setAttribute("id",js_script);

G__20466.setAttribute("class","dynamicjs");

G__20466.setAttribute("src",js_script);
...
kaleidoscope.ui.components.article.article = (function kaleidoscope$ui$components$article$article(p__20467){
var map__20468 = p__20467;
var map__20468__$1 = cljs.core.__destructure_map(map__20468);
var article_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20468__$1,new cljs.core.Keyword(null,"article-title","article-title",-1665332721));
var author = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20468__$1,new cljs.core.Keyword(null,"author","author",2111686192));
var modified_at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20468__$1,new cljs.core.Keyword(null,"modified-at","modified-at",-932048179));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20468__$1,new cljs.core.Keyword(null,"content","content",15833224));
