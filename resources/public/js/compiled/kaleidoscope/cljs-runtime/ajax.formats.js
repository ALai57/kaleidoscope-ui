...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__40466){
var map__40467 = p__40466;
var map__40467__$1 = cljs.core.__destructure_map(map__40467);
var request = map__40467__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40467__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__40472 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__40472.cljs$core$IFn$_invoke$arity$1 ? fexpr__40472.cljs$core$IFn$_invoke$arity$1(response) : fexpr__40472.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__40473 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__40473.cljs$core$IFn$_invoke$arity$1 ? fexpr__40473.cljs$core$IFn$_invoke$arity$1(response) : fexpr__40473.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__40474){
var map__40475 = p__40474;
var map__40475__$1 = cljs.core.__destructure_map(map__40475);
var request = map__40475__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40475__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
