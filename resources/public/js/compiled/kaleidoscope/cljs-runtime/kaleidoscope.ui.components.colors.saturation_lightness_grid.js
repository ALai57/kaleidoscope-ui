...
kaleidoscope.ui.components.colors.saturation_lightness_grid.clamp = (function kaleidoscope$ui$components$colors$saturation_lightness_grid$clamp(val,p__16209){
var map__16210 = p__16209;
var map__16210__$1 = cljs.core.__destructure_map(map__16210);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__16210__$1,new cljs.core.Keyword(null,"min","min",444991522),(0));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__16210__$1,new cljs.core.Keyword(null,"max","max",61366548),(100));
if((val < min)){
return min;
} else {
if((val > max)){
...
kaleidoscope.ui.components.colors.saturation_lightness_grid.euclidean_distance = (function kaleidoscope$ui$components$colors$saturation_lightness_grid$euclidean_distance(p__16211,p__16212){
var vec__16213 = p__16211;
var x1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16213,(0),null);
var y1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16213,(1),null);
var vec__16216 = p__16212;
var x2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16216,(0),null);
var y2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16216,(1),null);
...
kaleidoscope.ui.components.colors.saturation_lightness_grid.calculate_marker_coordinates = (function kaleidoscope$ui$components$colors$saturation_lightness_grid$calculate_marker_coordinates(p__16219){
var map__16220 = p__16219;
var map__16220__$1 = cljs.core.__destructure_map(map__16220);
var base_saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16220__$1,new cljs.core.Keyword(null,"base-saturation","base-saturation",-1809016794));
var base_lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16220__$1,new cljs.core.Keyword(null,"base-lightness","base-lightness",-193691637));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__16220__$1,new cljs.core.Keyword(null,"r","r",-471384190),(20));
var theta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__16220__$1,new cljs.core.Keyword(null,"theta","theta",-427510258),(-45));
...
kaleidoscope.ui.components.colors.saturation_lightness_grid._centered_dot = (function kaleidoscope$ui$components$colors$saturation_lightness_grid$_centered_dot(p__16221){
var map__16222 = p__16221;
var map__16222__$1 = cljs.core.__destructure_map(map__16222);
var radius = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16222__$1,new cljs.core.Keyword(null,"radius","radius",-2073122258));
var opacity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16222__$1,new cljs.core.Keyword(null,"opacity","opacity",397153780));
var units_from_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16222__$1,new cljs.core.Keyword(null,"units-from-origin","units-from-origin",-530337642));
...
kaleidoscope.ui.components.colors.saturation_lightness_grid.marker = (function kaleidoscope$ui$components$colors$saturation_lightness_grid$marker(p__16223){
var map__16224 = p__16223;
var map__16224__$1 = cljs.core.__destructure_map(map__16224);
var activate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16224__$1,new cljs.core.Keyword(null,"activate","activate",441219614));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16224__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var base_saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16224__$1,new cljs.core.Keyword(null,"base-saturation","base-saturation",-1809016794));
var base_lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16224__$1,new cljs.core.Keyword(null,"base-lightness","base-lightness",-193691637));
var deactivate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16224__$1,new cljs.core.Keyword(null,"deactivate","deactivate",-1313810707));
var theta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16224__$1,new cljs.core.Keyword(null,"theta","theta",-427510258));
var radius = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16224__$1,new cljs.core.Keyword(null,"radius","radius",-2073122258));
var opacity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16224__$1,new cljs.core.Keyword(null,"opacity","opacity",397153780));
var units_from_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16224__$1,new cljs.core.Keyword(null,"units-from-origin","units-from-origin",-530337642));
var border_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16224__$1,new cljs.core.Keyword(null,"border-size","border-size",991975640));
...
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16225__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16225__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
...
kaleidoscope.ui.components.colors.saturation_lightness_grid.translate_origin_BANG_ = (function kaleidoscope$ui$components$colors$saturation_lightness_grid$translate_origin_BANG_(p__16242){
var map__16243 = p__16242;
var map__16243__$1 = cljs.core.__destructure_map(map__16243);
var mouse_coordinates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16243__$1,new cljs.core.Keyword(null,"mouse-coordinates","mouse-coordinates",1702910568));
var origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16243__$1,new cljs.core.Keyword(null,"origin","origin",1037372088));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16243__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var map__16244 = mouse_coordinates;
var map__16244__$1 = cljs.core.__destructure_map(map__16244);
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16244__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16244__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
...
var G__16245 = cljs.core.deref(origin);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__16245) : on_change.call(null,G__16245));
});
kaleidoscope.ui.components.colors.saturation_lightness_grid.rotate_BANG_ = (function kaleidoscope$ui$components$colors$saturation_lightness_grid$rotate_BANG_(p__16246){
var map__16247 = p__16246;
var map__16247__$1 = cljs.core.__destructure_map(map__16247);
var mouse_coordinates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16247__$1,new cljs.core.Keyword(null,"mouse-coordinates","mouse-coordinates",1702910568));
var origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16247__$1,new cljs.core.Keyword(null,"origin","origin",1037372088));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16247__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var units_from_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16247__$1,new cljs.core.Keyword(null,"units-from-origin","units-from-origin",-530337642));
var map__16248 = mouse_coordinates;
var map__16248__$1 = cljs.core.__destructure_map(map__16248);
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16248__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16248__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
var saturation__$1 = kaleidoscope.ui.components.colors.saturation_lightness_grid.clamp(saturation,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),(0),new cljs.core.Keyword(null,"max","max",61366548),(100)], null));
var lightness__$1 = kaleidoscope.ui.components.colors.saturation_lightness_grid.clamp(lightness,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),(0),new cljs.core.Keyword(null,"max","max",61366548),(100)], null));
var map__16249 = cljs.core.deref(origin);
var map__16249__$1 = cljs.core.__destructure_map(map__16249);
var origin_saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16249__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var origin_lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16249__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
...
var G__16250 = cljs.core.deref(origin);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__16250) : on_change.call(null,G__16250));
});
kaleidoscope.ui.components.colors.saturation_lightness_grid.saturation_lightness_grid = (function kaleidoscope$ui$components$colors$saturation_lightness_grid$saturation_lightness_grid(p__16251){
var map__16252 = p__16251;
var map__16252__$1 = cljs.core.__destructure_map(map__16252);
var grid_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16252__$1,new cljs.core.Keyword(null,"grid-size","grid-size",2138480144));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16252__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16252__$1,new cljs.core.Keyword(null,"origin","origin",1037372088));
...
return event.stopPropagation();
}),new cljs.core.Keyword(null,"position","position",-2011731912),"absolute",new cljs.core.Keyword(null,"style","style",-496642736),grid_props,"z-index",(100)], null),(function (){var iter__5523__auto__ = (function kaleidoscope$ui$components$colors$saturation_lightness_grid$saturation_lightness_grid_$_iter__16253(s__16254){
return (new cljs.core.LazySeq(null,(function (){
var s__16254__$1 = s__16254;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__16254__$1);
if(temp__5804__auto__){
var s__16254__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__16254__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__16254__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__16256 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__16255 = (0);
while(true){
if((i__16255 < size__5522__auto__)){
var background = cljs.core._nth(c__5521__auto__,i__16255);
cljs.core.chunk_append(b__16256,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([grid_props,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background","background",-863952629),background], null)], 0))], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["background-component-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(background)].join('')], null)));

var G__16311 = (i__16255 + (1));
i__16255 = G__16311;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16256),kaleidoscope$ui$components$colors$saturation_lightness_grid$saturation_lightness_grid_$_iter__16253(cljs.core.chunk_rest(s__16254__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16256),null);
}
} else {
var background = cljs.core.first(s__16254__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([grid_props,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background","background",-863952629),background], null)], 0))], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["background-component-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(background)].join('')], null)),kaleidoscope$ui$components$colors$saturation_lightness_grid$saturation_lightness_grid_$_iter__16253(cljs.core.rest(s__16254__$2)));
}
} else {
return null;
}
...
})(),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function kaleidoscope$ui$components$colors$saturation_lightness_grid$saturation_lightness_grid_$_iter__16257(s__16258){
return (new cljs.core.LazySeq(null,(function (){
...
var n = cljs.core._nth(c__5521__auto__,i__16259);
cljs.core.chunk_append(b__16260,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.colors.saturation_lightness_grid.marker,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"r","r",-471384190),new cljs.core.Keyword(null,"base-saturation","base-saturation",-1809016794),new cljs.core.Keyword(null,"base-lightness","base-lightness",-193691637),new cljs.core.Keyword(null,"deactivate","deactivate",-1313810707),new cljs.core.Keyword(null,"theta","theta",-427510258),new cljs.core.Keyword(null,"radius","radius",-2073122258),new cljs.core.Keyword(null,"opacity","opacity",397153780),new cljs.core.Keyword(null,"units-from-origin","units-from-origin",-530337642),new cljs.core.Keyword(null,"border-size","border-size",991975640),new cljs.core.Keyword(null,"activate","activate",441219614)],[(n * new cljs.core.Keyword(null,"spacing","spacing",204422175).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(origin))),new cljs.core.Keyword(null,"saturation","saturation",-14247929).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(origin)),new cljs.core.Keyword(null,"lightness","lightness",-2040901930).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(origin)),((function (i__16259,n,c__5521__auto__,size__5522__auto__,b__16260,s__16258__$2,temp__5804__auto__,_BANG_grid_ref,active_element,grid_props,origin_marker_QMARK_,map__16252,map__16252__$1,grid_size,on_change,origin){
return (function (_event){
return cljs.core.reset_BANG_(active_element,null);
});})(i__16259,n,c__5521__auto__,size__5522__auto__,b__16260,s__16258__$2,temp__5804__auto__,_BANG_grid_ref,active_element,grid_props,origin_marker_QMARK_,map__16252,map__16252__$1,grid_size,on_change,origin))
,new cljs.core.Keyword(null,"theta","theta",-427510258).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(origin)),(10),(((n === (0)))?(70):(30)),n,grid_size,((function (i__16259,n,c__5521__auto__,size__5522__auto__,b__16260,s__16258__$2,temp__5804__auto__,_BANG_grid_ref,active_element,grid_props,origin_marker_QMARK_,map__16252,map__16252__$1,grid_size,on_change,origin){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16260),kaleidoscope$ui$components$colors$saturation_lightness_grid$saturation_lightness_grid_$_iter__16257(cljs.core.chunk_rest(s__16258__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16260),null);
}
} else {
var n = cljs.core.first(s__16258__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.colors.saturation_lightness_grid.marker,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"r","r",-471384190),new cljs.core.Keyword(null,"base-saturation","base-saturation",-1809016794),new cljs.core.Keyword(null,"base-lightness","base-lightness",-193691637),new cljs.core.Keyword(null,"deactivate","deactivate",-1313810707),new cljs.core.Keyword(null,"theta","theta",-427510258),new cljs.core.Keyword(null,"radius","radius",-2073122258),new cljs.core.Keyword(null,"opacity","opacity",397153780),new cljs.core.Keyword(null,"units-from-origin","units-from-origin",-530337642),new cljs.core.Keyword(null,"border-size","border-size",991975640),new cljs.core.Keyword(null,"activate","activate",441219614)],[(n * new cljs.core.Keyword(null,"spacing","spacing",204422175).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(origin))),new cljs.core.Keyword(null,"saturation","saturation",-14247929).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(origin)),new cljs.core.Keyword(null,"lightness","lightness",-2040901930).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(origin)),((function (n,s__16258__$2,temp__5804__auto__,_BANG_grid_ref,active_element,grid_props,origin_marker_QMARK_,map__16252,map__16252__$1,grid_size,on_change,origin){
return (function (_event){
return cljs.core.reset_BANG_(active_element,null);
});})(n,s__16258__$2,temp__5804__auto__,_BANG_grid_ref,active_element,grid_props,origin_marker_QMARK_,map__16252,map__16252__$1,grid_size,on_change,origin))
,new cljs.core.Keyword(null,"theta","theta",-427510258).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(origin)),(10),(((n === (0)))?(70):(30)),n,grid_size,((function (n,s__16258__$2,temp__5804__auto__,_BANG_grid_ref,active_element,grid_props,origin_marker_QMARK_,map__16252,map__16252__$1,grid_size,on_change,origin){
return (function (event){
return cljs.core.reset_BANG_(active_element,event.target);
});})(n,s__16258__$2,temp__5804__auto__,_BANG_grid_ref,active_element,grid_props,origin_marker_QMARK_,map__16252,map__16252__$1,grid_size,on_change,origin))
])], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["marker-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)),kaleidoscope$ui$components$colors$saturation_lightness_grid$saturation_lightness_grid_$_iter__16257(cljs.core.rest(s__16258__$2)));
}
} else {
return null;
}
