...
return [(function (){var pred__39641 = cljs.core.instance_QMARK_;
var expr__39642 = reactive_val;
if(cljs.core.truth_((pred__39641.cljs$core$IFn$_invoke$arity$2 ? pred__39641.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__39642) : pred__39641.call(null,reagent.ratom.RAtom,expr__39642)))){
return "ra";
} else {
if(cljs.core.truth_((pred__39641.cljs$core$IFn$_invoke$arity$2 ? pred__39641.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__39642) : pred__39641.call(null,reagent.ratom.RCursor,expr__39642)))){
return "rc";
} else {
if(cljs.core.truth_((pred__39641.cljs$core$IFn$_invoke$arity$2 ? pred__39641.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__39642) : pred__39641.call(null,reagent.ratom.Reaction,expr__39642)))){
return "rx";
} else {
if(cljs.core.truth_((pred__39641.cljs$core$IFn$_invoke$arity$2 ? pred__39641.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__39642) : pred__39641.call(null,reagent.ratom.Track,expr__39642)))){
return "tr";
} else {
return "other";
}
