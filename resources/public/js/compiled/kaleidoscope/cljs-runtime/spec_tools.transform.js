...
if((x instanceof cljs.core.Keyword)){
var G__18982 = spec;
var G__18983 = spec_tools.transform.keyword__GT_string(spec,x);
...
if((x instanceof cljs.core.Keyword)){
var G__18984 = spec;
var G__18985 = spec_tools.transform.keyword__GT_string(spec,x);
...
if(typeof x === 'number'){
var G__18986 = spec;
var G__18987 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__18986,G__18987) : f.call(null,G__18986,G__18987));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e19022){if((e19022 instanceof Error)){
var ___$1 = e19022;
return x;
} else {
throw e19022;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__19025,x){
var map__19026 = p__19025;
var map__19026__$1 = cljs.core.__destructure_map(map__19026);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19026__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__19027,x){
var map__19028 = p__19027;
var map__19028__$1 = cljs.core.__destructure_map(map__19028);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19028__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__19050,x){
var map__19055 = p__19050;
var map__19055__$1 = cljs.core.__destructure_map(map__19055);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19055__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
