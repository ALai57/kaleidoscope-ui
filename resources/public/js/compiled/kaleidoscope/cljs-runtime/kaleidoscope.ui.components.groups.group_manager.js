...
var G__18091 = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(row);
return (delete_member_BANG_.cljs$core$IFn$_invoke$arity$1 ? delete_member_BANG_.cljs$core$IFn$_invoke$arity$1(G__18091) : delete_member_BANG_.call(null,G__18091));
...
kaleidoscope.ui.components.groups.group_manager.add_group_item = (function kaleidoscope$ui$components$groups$group_manager$add_group_item(p__18098){
var map__18099 = p__18098;
var map__18099__$1 = cljs.core.__destructure_map(map__18099);
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18099__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18099__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__18099__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (x){
...
kaleidoscope.ui.components.groups.group_manager.list_entry = (function kaleidoscope$ui$components$groups$group_manager$list_entry(p__18104){
var map__18105 = p__18104;
var map__18105__$1 = cljs.core.__destructure_map(map__18105);
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18105__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18105__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__18105__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (x){
return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Clicked ",text], 0));
}));
var delete_group_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18105__$1,new cljs.core.Keyword(null,"delete-group!","delete-group!",-2140004756));
...
kaleidoscope.ui.components.groups.group_manager.group_entry = (function kaleidoscope$ui$components$groups$group_manager$group_entry(p__18112){
var map__18113 = p__18112;
var map__18113__$1 = cljs.core.__destructure_map(map__18113);
var group = map__18113__$1;
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18113__$1,new cljs.core.Keyword(null,"idx","idx",1053688473));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18113__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18113__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var display_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18113__$1,new cljs.core.Keyword(null,"display-name","display-name",694513143));
var memberships = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18113__$1,new cljs.core.Keyword(null,"memberships","memberships",1865599157));
var delete_group_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18113__$1,new cljs.core.Keyword(null,"delete-group!","delete-group!",-2140004756));
var delete_member_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18113__$1,new cljs.core.Keyword(null,"delete-member!","delete-member!",-2061417610));
var add_member_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18113__$1,new cljs.core.Keyword(null,"add-member!","add-member!",-23827290));
...
kaleidoscope.ui.components.groups.group_manager.add_group_form = (function kaleidoscope$ui$components$groups$group_manager$add_group_form(p__18118){
var map__18119 = p__18118;
var map__18119__$1 = cljs.core.__destructure_map(map__18119);
var add_group_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18119__$1,new cljs.core.Keyword(null,"add-group!","add-group!",999555200));
...
kaleidoscope.ui.components.groups.group_manager.group_manager = (function kaleidoscope$ui$components$groups$group_manager$group_manager(p__18122){
var map__18123 = p__18122;
var map__18123__$1 = cljs.core.__destructure_map(map__18123);
var groups = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18123__$1,new cljs.core.Keyword(null,"groups","groups",-136896102));
var open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18123__$1,new cljs.core.Keyword(null,"open","open",-1763596448));
var add_group_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__18123__$1,new cljs.core.Keyword(null,"add-group!","add-group!",999555200),(function (group_name){
...
}),null)),null,1138178163,null);
}));
var delete_group_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__18123__$1,new cljs.core.Keyword(null,"delete-group!","delete-group!",-2140004756),(function (group){
...
}),null)),null,62153851,null);
}));
var add_member_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__18123__$1,new cljs.core.Keyword(null,"add-member!","add-member!",-23827290),(function (group,member){
...
}),null)),null,100102577,null);
}));
var delete_member_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__18123__$1,new cljs.core.Keyword(null,"delete-member!","delete-member!",-2061417610),(function (group,member){
...
var c__5521__auto__ = cljs.core.chunk_first(s__18125__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__18127 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__18126 = (0);
while(true){
if((i__18126 < size__5522__auto__)){
var map__18128 = cljs.core._nth(c__5521__auto__,i__18126);
var map__18128__$1 = cljs.core.__destructure_map(map__18128);
var group = map__18128__$1;
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18128__$1,new cljs.core.Keyword(null,"idx","idx",1053688473));
cljs.core.chunk_append(b__18127,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.groups.group_manager.group_entry,group], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["idx-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx),"-ge"].join('')], null)));

var G__18134 = (i__18126 + (1));
i__18126 = G__18134;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__18127),kaleidoscope$ui$components$groups$group_manager$group_manager_$_iter__18124(cljs.core.chunk_rest(s__18125__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__18127),null);
}
} else {
var map__18129 = cljs.core.first(s__18125__$2);
var map__18129__$1 = cljs.core.__destructure_map(map__18129);
var group = map__18129__$1;
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18129__$1,new cljs.core.Keyword(null,"idx","idx",1053688473));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.groups.group_manager.group_entry,group], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["idx-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx),"-ge"].join('')], null)),kaleidoscope$ui$components$groups$group_manager$group_manager_$_iter__18124(cljs.core.rest(s__18125__$2)));
}
} else {
return null;
}
