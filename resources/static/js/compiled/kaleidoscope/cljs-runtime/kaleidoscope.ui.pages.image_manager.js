...
console.log("Upload photo",files);
...
kaleidoscope.ui.pages.image_manager._edit_photo_BANG_ = (function kaleidoscope$ui$pages$image_manager$_edit_photo_BANG_(payload){
console.log("Edit photo: ",payload);

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"edit-photo!","edit-photo!",-948161522),kaleidoscope.ui.utils.core.clojurize(payload)], null));
});
kaleidoscope.ui.pages.image_manager._image_manager_page = (function kaleidoscope$ui$pages$image_manager$_image_manager_page(p__17595){
var map__17596 = p__17595;
var map__17596__$1 = cljs.core.__destructure_map(map__17596);
var images = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17596__$1,new cljs.core.Keyword(null,"images","images",1757475080));
var albums = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17596__$1,new cljs.core.Keyword(null,"albums","albums",-2017039447));
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17596__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var notification_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17596__$1,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787));
var auth_token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17596__$1,new cljs.core.Keyword(null,"auth-token","auth-token",30990976));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.navbar.nav_bar,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"user","user",1532431356),user,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787),notification_type], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin","margin",-995903681),"10px"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.image_browser.image_browser,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"images","images",1757475080),images,new cljs.core.Keyword(null,"photo-manager","photo-manager",-1460293253),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"add-photo","add-photo",11690143),kaleidoscope.ui.pages.image_manager._add_photo_BANG_,new cljs.core.Keyword(null,"edit-photo","edit-photo",21949127),kaleidoscope.ui.pages.image_manager._edit_photo_BANG_], null)], null)], null)], null)], null);
});
kaleidoscope.ui.pages.image_manager.image_manager_page = (function kaleidoscope$ui$pages$image_manager$image_manager_page(p__17597){
var map__17598 = p__17597;
var map__17598__$1 = cljs.core.__destructure_map(map__17598);
var images = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17598__$1,new cljs.core.Keyword(null,"images","images",1757475080));
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17598__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var notification_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17598__$1,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787));
