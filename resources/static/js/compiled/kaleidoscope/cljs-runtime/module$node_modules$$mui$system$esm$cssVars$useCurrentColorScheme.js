...
localStorage.getItem(key)||void 0)||localStorage.setItem(key,defaultValue)}catch(e){}return value||defaultValue}}Object.defineProperty(exports,"__esModule",{value:!0});exports.getSystemMode=getSystemMode;exports.getColorScheme=getColorScheme;exports.default=function(options){const {defaultMode="light",defaultLightColorScheme,defaultDarkColorScheme,supportedColorSchemes=[],modeStorageKey=_getInitColorSchemeScript.DEFAULT_MODE_STORAGE_KEY,colorSchemeStorageKey=_getInitColorSchemeScript.DEFAULT_COLOR_SCHEME_STORAGE_KEY,
...
obj[key]}newObj.default=obj;nodeInterop&&nodeInterop.set(obj,newObj);return newObj}(require("module$node_modules$react$index")),_getInitColorSchemeScript=require("module$node_modules$$mui$system$esm$cssVars$getInitColorSchemeScript")}
//# sourceMappingURL=module$node_modules$$mui$system$esm$cssVars$useCurrentColorScheme.js.map
