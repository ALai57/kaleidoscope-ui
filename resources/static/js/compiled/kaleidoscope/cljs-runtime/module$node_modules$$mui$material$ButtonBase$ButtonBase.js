...
React=_interopRequireWildcard(require("module$node_modules$react$index"));global=_interopRequireDefault(require("module$node_modules$prop_types$index"));var _clsx=_interopRequireDefault(require("module$node_modules$clsx$dist$clsx_m"));module=require("module$node_modules$$mui$utils$esm$index");var _composeClasses=_interopRequireDefault(require("module$node_modules$$mui$base$composeClasses$index")),_styled=_interopRequireDefault(require("module$node_modules$$mui$material$styles$styled")),_useThemeProps=
_interopRequireDefault(require("module$node_modules$$mui$material$styles$useThemeProps")),_useForkRef=_interopRequireDefault(require("module$node_modules$$mui$material$utils$useForkRef")),_useEventCallback=_interopRequireDefault(require("module$node_modules$$mui$material$utils$useEventCallback")),_useIsFocusVisible=_interopRequireDefault(require("module$node_modules$$mui$material$utils$useIsFocusVisible")),_TouchRipple=_interopRequireDefault(require("module$node_modules$$mui$material$ButtonBase$TouchRipple")),
_buttonBaseClasses=_interopRequireWildcard(require("module$node_modules$$mui$material$ButtonBase$buttonBaseClasses")),_jsxRuntime=require("module$node_modules$react$jsx_runtime");const _excluded="action centerRipple children className component disabled disableRipple disableTouchRipple focusRipple focusVisibleClassName LinkComponent onBlur onClick onContextMenu onDragLeave onFocus onFocusVisible onKeyDown onKeyUp onMouseDown onMouseLeave onMouseUp onTouchEnd onTouchMove onTouchStart tabIndex TouchRippleProps touchRippleRef type".split(" "),
