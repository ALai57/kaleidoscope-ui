...
var no_stacktrace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41774__$1,new cljs.core.Keyword(null,"no-stacktrace?","no-stacktrace?",1701072694));
var stacktrace_fonts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41774__$1,new cljs.core.Keyword(null,"stacktrace-fonts","stacktrace-fonts",830799382));
var map__41775 = data;
var map__41775__$1 = cljs.core.__destructure_map(map__41775);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41775__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41775__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41775__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41775__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41775__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41775__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41775__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41775__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
 ...
 */
taoensso.timbre.default_config = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"min-level","min-level",1634684919),new cljs.core.Keyword(null,"debug","debug",-1608172596),new cljs.core.Keyword(null,"ns-filter","ns-filter",108598448),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, ["*",null], null), null),new cljs.core.Keyword(null,"middleware","middleware",1462115504),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807),taoensso.timbre.default_timestamp_opts,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn,new cljs.core.Keyword(null,"appenders","appenders",1245583998),(((typeof window !== 'undefined'))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"console","console",1228072057),(function (){var G__41780 = cljs.core.PersistentArrayMap.EMPTY;
return (taoensso.timbre.console_appender.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.console_appender.cljs$core$IFn$_invoke$arity$1(G__41780) : taoensso.timbre.console_appender.call(null,G__41780));
})()], null):new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"println","println",1920840330),(function (){var G__41781 = cljs.core.PersistentArrayMap.EMPTY;
return (taoensso.timbre.println_appender.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.println_appender.cljs$core$IFn$_invoke$arity$1(G__41781) : taoensso.timbre.println_appender.call(null,G__41781));
})()], null))], null);
...
var G__41784 = (function (_old){
return m;
});
return (taoensso.timbre.swap_config_BANG_.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.swap_config_BANG_.cljs$core$IFn$_invoke$arity$1(G__41784) : taoensso.timbre.swap_config_BANG_.call(null,G__41784));
});
taoensso.timbre.merge_config_BANG_ = (function taoensso$timbre$merge_config_BANG_(m){
var G__41786 = (function (old){
...
return (taoensso.timbre.swap_config_BANG_.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre.swap_config_BANG_.cljs$core$IFn$_invoke$arity$1(G__41786) : taoensso.timbre.swap_config_BANG_.call(null,G__41786));
});
...
var G__41966 = (i__5770__auto___41964 + (1));
i__5770__auto___41964 = G__41966;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq41788){
var G__41789 = cljs.core.first(seq41788);
var seq41788__$1 = cljs.core.next(seq41788);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41789,seq41788__$1);
}));
...
var err_41967 = "Invalid Timbre logging level: should be e/o #{:trace :debug :info :warn :error :fatal :report}";
var level__GT_int_41968 = (function (p1__41792_SHARP_){
var G__41794 = p1__41792_SHARP_;
...
if(cljs.core.truth_(level__GT_int_41968(x))){
return true;
} else {
return false;
}
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(err_41967,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"given","given",716253602),x,new cljs.core.Keyword(null,"type","type",1174270348),cljs.core.type(x)], null));
}
});

taoensso.timbre.valid_level__GT_int = (function taoensso$timbre$valid_level__GT_int(x){
var or__5045__auto__ = level__GT_int_41968(x);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(err_41967,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"given","given",716253602),x,new cljs.core.Keyword(null,"type","type",1174270348),cljs.core.type(x)], null));
...
var valid_level__GT_int_41971 = taoensso.timbre.valid_level__GT_int;
/**
 * Implementation detail.
 */
taoensso.timbre.level_GT__EQ_ = (function taoensso$timbre$level_GT__EQ_(x,y){
return ((valid_level__GT_int_41971.cljs$core$IFn$_invoke$arity$1 ? valid_level__GT_int_41971.cljs$core$IFn$_invoke$arity$1(x) : valid_level__GT_int_41971.call(null,x)) >= (valid_level__GT_int_41971.cljs$core$IFn$_invoke$arity$1 ? valid_level__GT_int_41971.cljs$core$IFn$_invoke$arity$1(y) : valid_level__GT_int_41971.call(null,y)));
});
var fn_QMARK__41972 = cljs.core.fn_QMARK_;
var compile_41973 = taoensso.encore.fmemoize((function (x){
return taoensso.encore.compile_str_filter(x);
}));
var conform_QMARK__STAR__41974 = taoensso.encore.fmemoize((function (x,ns){
var fexpr__41798 = compile_41973(x);
return (fexpr__41798.cljs$core$IFn$_invoke$arity$1 ? fexpr__41798.cljs$core$IFn$_invoke$arity$1(ns) : fexpr__41798.call(null,ns));
}));
var conform_QMARK__41975 = (function (ns_filter,ns){
if(cljs.core.truth_((fn_QMARK__41972.cljs$core$IFn$_invoke$arity$1 ? fn_QMARK__41972.cljs$core$IFn$_invoke$arity$1(ns_filter) : fn_QMARK__41972.call(null,ns_filter)))){
return (ns_filter.cljs$core$IFn$_invoke$arity$1 ? ns_filter.cljs$core$IFn$_invoke$arity$1(ns) : ns_filter.call(null,ns));
} else {
return conform_QMARK__STAR__41974(ns_filter,ns);
}
});
/**
 * Implementation detail.
...
if(cljs.core.truth_(conform_QMARK__41975(ns_filter,ns))){
return true;
} else {
return false;
}
...
return taoensso.encore.rsome((function (p__41799){
var vec__41800 = p__41799;
var ns_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41800,(0),null);
var min_level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41800,(1),null);
if(cljs.core.truth_(conform_QMARK__STAR__41974(ns_pattern,ns))){
...
var valid_level_41977 = taoensso.timbre.valid_level;
var ns__GT__QMARK_min_level_41978 = taoensso.timbre.ns__GT__QMARK_min_level;
taoensso.timbre.get_min_level = (function taoensso$timbre$get_min_level(default$,x,ns){
var G__41804 = (function (){var or__5045__auto__ = ((cljs.core.vector_QMARK_(x))?ns__GT__QMARK_min_level_41978(x,ns):x);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return default$;
...
return (valid_level_41977.cljs$core$IFn$_invoke$arity$1 ? valid_level_41977.cljs$core$IFn$_invoke$arity$1(G__41804) : valid_level_41977.call(null,G__41804));
});
var leglist_41979 = (function (x){
if(cljs.core.truth_(x)){
if(cljs.core.truth_((function (){var fexpr__41805 = cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY,cljs.core.PersistentHashSet.EMPTY]);
return (fexpr__41805.cljs$core$IFn$_invoke$arity$1 ? fexpr__41805.cljs$core$IFn$_invoke$arity$1(x) : fexpr__41805.call(null,x));
})())){
return null;
} else {
return x;
...
var ns_whitelist__$1 = leglist_41979(ns_whitelist);
var ns_blacklist__$1 = leglist_41979(ns_blacklist);
...
var level_GT__EQ__41982 = taoensso.timbre.level_GT__EQ_;
var may_log_ns_QMARK__41983 = taoensso.timbre.may_log_ns_QMARK_;
var get_min_level_41984 = taoensso.timbre.get_min_level;
var legacy_ns_filter_41985 = taoensso.timbre.legacy_ns_filter;
/**
 * Implementation detail.
...
var min_level = (function (){var G__41816 = default_min_level;
var G__41817 = (function (){var or__5045__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"min-level","min-level",1634684919));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var G__41818 = _QMARK_ns_str;
return (get_min_level_41984.cljs$core$IFn$_invoke$arity$3 ? get_min_level_41984.cljs$core$IFn$_invoke$arity$3(G__41816,G__41817,G__41818) : get_min_level_41984.call(null,G__41816,G__41817,G__41818));
})();
if(cljs.core.truth_((level_GT__EQ__41982.cljs$core$IFn$_invoke$arity$2 ? level_GT__EQ__41982.cljs$core$IFn$_invoke$arity$2(level,min_level) : level_GT__EQ__41982.call(null,level,min_level)))){
...
var G__41819 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"ns-whitelist","ns-whitelist",-1717299774));
var G__41820 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"ns-blacklist","ns-blacklist",1957763142));
return (legacy_ns_filter_41985.cljs$core$IFn$_invoke$arity$2 ? legacy_ns_filter_41985.cljs$core$IFn$_invoke$arity$2(G__41819,G__41820) : legacy_ns_filter_41985.call(null,G__41819,G__41820));
}
})();
if(cljs.core.truth_(temp__5802__auto__)){
var ns_filter = temp__5802__auto__;
if(cljs.core.truth_((may_log_ns_QMARK__41983.cljs$core$IFn$_invoke$arity$2 ? may_log_ns_QMARK__41983.cljs$core$IFn$_invoke$arity$2(ns_filter,_QMARK_ns_str) : may_log_ns_QMARK__41983.call(null,ns_filter,_QMARK_ns_str)))){
return true;
} else {
return false;
}
...
var vec__41828 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41828,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__41837 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41837,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__41840 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41840,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.encore.vrest(vargs__$1):vargs__$1);
...
var map__41851 = timestamp_opts;
var map__41851__$1 = cljs.core.__destructure_map(map__41851);
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41851__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var instant_42018 = (new Date());
var context_42019 = taoensso.timbre._STAR_context_STAR_;
var vargs_42020 = cljs.core.deref(vargs_);
var vec__41868_42021 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_42020);
var _QMARK_err_42022__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41868_42021,(0),null);
var _QMARK_meta_42023 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41868_42021,(1),null);
var _QMARK_msg_fmt_42024 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41868_42021,(2),null);
var vargs_42025__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41868_42021,(3),null);
var data_42026 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"spying?","spying?",1753444487),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_42018,spying_QMARK_,config,vargs_42025__$1,_QMARK_file,(function (){var fexpr__41871 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__41871.cljs$core$IFn$_invoke$arity$1 ? fexpr__41871.cljs$core$IFn$_invoke$arity$1(level) : fexpr__41871.call(null,level));
})(),_QMARK_ns_str,level,_QMARK_err_42022__$1,context_42019,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_42022__$1;
}),null)),_QMARK_meta_42023,_QMARK_msg_fmt_42024]));
var _QMARK_data_42027 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_42026,new cljs.core.Keyword(null,"middleware","middleware",1462115504).cljs$core$IFn$_invoke$arity$1(config));
var temp__5804__auto___42028 = _QMARK_data_42027;
if(cljs.core.truth_(temp__5804__auto___42028)){
var data_42029__$1 = temp__5804__auto___42028;
var map__41872_42030 = data_42029__$1;
var map__41872_42031__$1 = cljs.core.__destructure_map(map__41872_42030);
var vargs_42032__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41872_42031__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_42033__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_42029__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_42032__$2;
}),null)));
var data_42034__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_42033__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
var G__41875 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__41875)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__41875)){
return taoensso.timbre.str_join(vargs_42032__$2);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__41875)){
if(typeof _QMARK_msg_fmt_42024 === 'string'){
} else {
...
return taoensso.encore.format_STAR_(_QMARK_msg_fmt_42024,vargs_42032__$2);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41875)].join('')));
...
return cljs.core.hash(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [callsite_id,_QMARK_msg_fmt_42024,cljs.core.get.cljs$core$IFn$_invoke$arity$3(_QMARK_meta_42023,new cljs.core.Keyword(null,"hash","hash",-13781596),vargs_42032__$2)], null));
}),null))], 0));
var output_fn1_42035 = taoensso.encore.fmemoize(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
var timestamp_opts1_42036 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(taoensso.timbre.default_timestamp_opts,cljs.core.get.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.Keyword(null,"timestamp-opts","timestamp-opts",-1359534807)));
var get_timestamp__42037 = taoensso.encore.fmemoize((function (opts){
return (new cljs.core.Delay((function (){
return taoensso.timbre.get_timestamp(opts,cljs.core.get.cljs$core$IFn$_invoke$arity$2(data_42034__$3,new cljs.core.Keyword(null,"instant","instant",655498374)));
}),null));
}));
...
return cljs.core.not((function (){var G__41884 = cljs.core.force(new cljs.core.Keyword(null,"hash_","hash_",-827203612).cljs$core$IFn$_invoke$arity$1(data_42034__$3));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__41884) : rl_fn.call(null,G__41884));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__41886 = appender;
var map__41886__$1 = cljs.core.__destructure_map(map__41886);
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41886__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41886__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
...
return get_timestamp__42037(timestamp_opts1_42036);
} else {
return get_timestamp__42037(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(timestamp_opts1_42036,opts));
}
})();
var output_ = (new cljs.core.Delay((function (){
var G__41890 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_42034__$3,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_);
return (output_fn.cljs$core$IFn$_invoke$arity$1 ? output_fn.cljs$core$IFn$_invoke$arity$1(G__41890) : output_fn.call(null,G__41890));
}),null));
var data__$4 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(data_42034__$3,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417),timestamp_], null));
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq41914){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq41914));
}));


var ret__5824__auto___42056 = (function (){
taoensso.timbre.with_log_level = (function taoensso$timbre$with_log_level(var_args){
var args__5775__auto__ = [];
var len__5769__auto___42057 = arguments.length;
var i__5770__auto___42062 = (0);
while(true){
if((i__5770__auto___42062 < len__5769__auto___42057)){
args__5775__auto__.push((arguments[i__5770__auto___42062]));

var G__42063 = (i__5770__auto___42062 + (1));
i__5770__auto___42062 = G__42063;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.with_log_level.cljs$lang$applyTo = (function (seq41922){
var G__41923 = cljs.core.first(seq41922);
var seq41922__$1 = cljs.core.next(seq41922);
var G__41924 = cljs.core.first(seq41922__$1);
var seq41922__$2 = cljs.core.next(seq41922__$1);
var G__41925 = cljs.core.first(seq41922__$2);
var seq41922__$3 = cljs.core.next(seq41922__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41923,G__41924,G__41925,seq41922__$3);
}));
...
var ret__5824__auto___42064 = (function (){
taoensso.timbre.with_logging_config = (function taoensso$timbre$with_logging_config(var_args){
var args__5775__auto__ = [];
var len__5769__auto___42065 = arguments.length;
var i__5770__auto___42067 = (0);
while(true){
if((i__5770__auto___42067 < len__5769__auto___42065)){
...
/** @this {Function} */
(taoensso.timbre.with_logging_config.cljs$lang$applyTo = (function (seq41929){
var G__41930 = cljs.core.first(seq41929);
var seq41929__$1 = cljs.core.next(seq41929);
var G__41931 = cljs.core.first(seq41929__$1);
var seq41929__$2 = cljs.core.next(seq41929__$1);
var G__41932 = cljs.core.first(seq41929__$2);
var seq41929__$3 = cljs.core.next(seq41929__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41930,G__41931,G__41932,seq41929__$3);
}));
...
var ret__5824__auto___42074 = (function (){
...
/** @this {Function} */
(taoensso.timbre.logp.cljs$lang$applyTo = (function (seq41933){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41934,G__41935,seq41933__$2);
}));
...
var ret__5824__auto___42085 = (function (){
