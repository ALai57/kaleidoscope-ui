...
})], null),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"Images",new cljs.core.Keyword(null,"description","description",-1428560544),"Create and manage Images. Not implemented yet!",new cljs.core.Keyword(null,"alt","alt",-3214426),"Manage images",new cljs.core.Keyword(null,"src","src",-1651076051),"/static/images/images.svg",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
})], null),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"Audiences",new cljs.core.Keyword(null,"description","description",-1428560544),"Control who has access to your content by defining an Audience",new cljs.core.Keyword(null,"src","src",-1651076051),"/static/images/audiences.svg",new cljs.core.Keyword(null,"alt","alt",-3214426),"Manage audiences",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
})], null),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"UI Customization",new cljs.core.Keyword(null,"description","description",-1428560544),"Customize the look and feel of the site",new cljs.core.Keyword(null,"src","src",-1651076051),"/static/images/audiences.svg",new cljs.core.Keyword(null,"alt","alt",-3214426),"Manage UI Customization",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
kaleidoscope.ui.components.manager.manager_card = (function kaleidoscope$ui$components$manager$manager_card(p__17630){
var map__17631 = p__17630;
var map__17631__$1 = cljs.core.__destructure_map(map__17631);
var capability = map__17631__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17631__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17631__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17631__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17631__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17631__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.components.container,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-wrap","flex-wrap",455413707),"wrap",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"row",new cljs.core.Keyword(null,"justify-content","justify-content",-1990475787),"center"], null)], null),(function (){var iter__5523__auto__ = (function kaleidoscope$ui$components$manager$manager_cards_$_iter__17632(s__17633){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__17635),kaleidoscope$ui$components$manager$manager_cards_$_iter__17632(cljs.core.chunk_rest(s__17633__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__17635),null);
}
} else {
var capability = cljs.core.first(s__17633__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f>","f>",1484564198),kaleidoscope.ui.components.manager.manager_card,capability], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(capability)], null)),kaleidoscope$ui$components$manager$manager_cards_$_iter__17632(cljs.core.rest(s__17633__$2)));
}
} else {
return null;
}
