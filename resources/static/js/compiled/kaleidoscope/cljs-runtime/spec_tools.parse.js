...
var fexpr__18865 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__18865.cljs$core$IFn$_invoke$arity$1 ? fexpr__18865.cljs$core$IFn$_invoke$arity$1(type) : fexpr__18865.call(null,type));
});
...
var G__18868 = spec_tools.impl.normalize_symbol(x);
var G__18869 = null;
var G__18870 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__18868,G__18869,G__18870) : spec_tools.parse.parse_form.call(null,G__18868,G__18869,G__18870));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__18871 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__18872 = x;
var G__18873 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__18871,G__18872,G__18873) : spec_tools.parse.parse_form.call(null,G__18871,G__18872,G__18873));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__18942 = cljs.spec.alpha.form(x);
var G__18943 = options;
x = G__18942;
options = G__18943;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__18874 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__18875 = null;
var G__18876 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__18874,G__18875,G__18876) : spec_tools.parse.parse_form.call(null,G__18874,G__18875,G__18876));
} else {
...
var G__18877 = parse_data;
var G__18877__$1 = (((G__18877 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__18877));
var G__18877__$2 = (((G__18877__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__18877__$1));
var G__18877__$3 = (((G__18877__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__18877__$2));
var G__18877__$4 = (((G__18877__$3 == null))?null:cljs.core.seq(G__18877__$3));
if((G__18877__$4 == null)){
return null;
} else {
return cljs.core.set(G__18877__$4);
}
}
});
...
var map__18885 = spec_tools.impl.parse_keys(form);
var map__18885__$1 = cljs.core.__destructure_map(map__18885);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18885__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18885__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18885__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18885__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18885__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__18886 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__18886__$1 = (cljs.core.truth_((function (){var or__5045__auto__ = req;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18886,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__18886);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18886__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__18886__$1;
}
}));
...
var vec__18891 = multi_spec_form;
...
var _ = first__18893;
var first__18893__$1 = cljs.core.first(seq__18892__$1);
var seq__18892__$2 = cljs.core.next(seq__18892__$1);
var multi_method_symbol = first__18893__$1;
var ___$1 = seq__18892__$2;
var form = vec__18891;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__18894){
var vec__18895 = p__18894;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18895,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18895,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__18898_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__18898_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__18899_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__18899_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__18900_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__18900_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18901_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__18901_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__18903 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__18903__$1 = cljs.core.__destructure_map(map__18903);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18903__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__18908 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__18908__$1 = cljs.core.__destructure_map(map__18908);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18908__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__18909,options){
var vec__18910 = p__18909;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18910,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18910,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18910,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__18914,options){
var vec__18915 = p__18914;
var seq__18916 = cljs.core.seq(vec__18915);
var first__18917 = cljs.core.first(seq__18916);
var seq__18916__$1 = cljs.core.next(seq__18916);
var ___$1 = first__18917;
var values = seq__18916__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__18913_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__18913_SHARP_,options);
}),values);
...
var type_priority = (function (p1__18919_SHARP_){
var G__18922 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__18921 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__18919_SHARP_);
return (fexpr__18921.cljs$core$IFn$_invoke$arity$1 ? fexpr__18921.cljs$core$IFn$_invoke$arity$1(G__18922) : fexpr__18921.call(null,G__18922));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18920_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__18920_SHARP_,options);
}),cljs.core.rest(form))));
}));
