...
Promise.resolve().then(executeQueue);buffer={push:function(x){pendingQueue.push(x);Promise.resolve().then(executeQueue)},filter:function(filter){pendingQueue=pendingQueue.filter(filter);return buffer}}}}}Object.defineProperty(exports,"__esModule",{value:!0});exports.createMedium=function(defaults,middleware){void 0===middleware&&(middleware=ItoI);return innerCreateMedium(defaults,middleware)};exports.createSidecarMedium=function(options){void 0===options&&(options={});var medium=innerCreateMedium(null);
medium.options=(0,_tslib.__assign)({async:!0,ssr:!1},options);return medium};var _tslib=require("module$node_modules$tslib$tslib_es6")}
//# sourceMappingURL=module$node_modules$use_sidecar$dist$es2015$medium.js.map
