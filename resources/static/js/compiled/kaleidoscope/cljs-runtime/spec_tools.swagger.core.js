...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__20364){
var map__20365 = p__20364;
var map__20365__$1 = cljs.core.__destructure_map(map__20365);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20365__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20365__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__20367 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20367,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20367,(1),null);
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__20373 = cljs.core.get_global_hierarchy;
...
var map__20374 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__20374__$1 = cljs.core.__destructure_map(map__20374);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20374__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20374__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__20375){
var vec__20376 = p__20375;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20376,(0),null);
var map__20379 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20376,(1),null);
var map__20379__$1 = cljs.core.__destructure_map(map__20379);
var schema = map__20379__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20379__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__20380 = cljs.core.get_global_hierarchy;
...
})(),(function (){var iter__5523__auto__ = (function spec_tools$swagger$core$iter__20381(s__20382){
return (new cljs.core.LazySeq(null,(function (){
var s__20382__$1 = s__20382;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__20382__$1);
if(temp__5804__auto__){
var s__20382__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20382__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__20382__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__20384 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__20383 = (0);
while(true){
if((i__20383 < size__5522__auto__)){
var vec__20385 = cljs.core._nth(c__5521__auto__,i__20383);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20385,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20385,(1),null);
cljs.core.chunk_append(b__20384,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20384),spec_tools$swagger$core$iter__20381(cljs.core.chunk_rest(s__20382__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20384),null);
}
} else {
var vec__20388 = cljs.core.first(s__20382__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20388,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20388,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__20381(cljs.core.rest(s__20382__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__20394){
var vec__20395 = p__20394;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20395,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20395,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__20398,p){
var vec__20399 = p__20398;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20399,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20399,(1),null);
var acc__$1 = vec__20399;
