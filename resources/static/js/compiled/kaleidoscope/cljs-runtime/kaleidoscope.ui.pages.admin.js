...
kaleidoscope.ui.pages.admin.success_QMARK_ = (function kaleidoscope$ui$pages$admin$success_QMARK_(p__18222){
var map__18223 = p__18222;
var map__18223__$1 = cljs.core.__destructure_map(map__18223);
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18223__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
...
var open = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(true);
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.modal.basic_modal,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(kaleidoscope.ui.pages.admin.authentication_success(),new cljs.core.Keyword(null,"open?","open?",1238443125),cljs.core.deref(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-close","on-close",-761178394),cljs.core.partial.cljs$core$IFn$_invoke$arity$3(cljs.core.reset_BANG_,open,false)], 0))], null);
});
} else {
if((response == null)){
return null;
...
var open = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(true);
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kaleidoscope.ui.components.modal.basic_modal,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(kaleidoscope.ui.pages.admin.authentication_failure(),new cljs.core.Keyword(null,"open?","open?",1238443125),cljs.core.deref(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-close","on-close",-761178394),cljs.core.partial.cljs$core$IFn$_invoke$arity$3(cljs.core.reset_BANG_,open,false)], 0))], null);
});
...
kaleidoscope.ui.pages.admin.user_profile = (function kaleidoscope$ui$pages$admin$user_profile(p__18230){
var map__18231 = p__18230;
var map__18231__$1 = cljs.core.__destructure_map(map__18231);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18231__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var user_event_handlers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18231__$1,new cljs.core.Keyword(null,"user-event-handlers","user-event-handlers",-1831736477));
var notification_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18231__$1,new cljs.core.Keyword(null,"notification-type","notification-type",-1128323787));
var map__18232 = user;
var map__18232__$1 = cljs.core.__destructure_map(map__18232);
var avatar_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18232__$1,new cljs.core.Keyword(null,"avatar_url","avatar_url",1520721439));
var username = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18232__$1,new cljs.core.Keyword(null,"username","username",1605666410));
var given_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18232__$1,new cljs.core.Keyword(null,"given_name","given_name",2027851744));
var family_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18232__$1,new cljs.core.Keyword(null,"family_name","family_name",853479664));
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18232__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var map__18233 = user_event_handlers;
var map__18233__$1 = cljs.core.__destructure_map(map__18233);
var on_admin_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18233__$1,new cljs.core.Keyword(null,"on-admin-click","on-admin-click",-133363126));
var on_edit_profile_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18233__$1,new cljs.core.Keyword(null,"on-edit-profile-click","on-edit-profile-click",-1224328428));
var on_logout_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18233__$1,new cljs.core.Keyword(null,"on-logout-click","on-logout-click",1259146498));
var on_login_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18233__$1,new cljs.core.Keyword(null,"on-login-click","on-login-click",1291820089));
...
kaleidoscope.ui.pages.admin.login_ui = (function kaleidoscope$ui$pages$admin$login_ui(p__18238){
...
var user_event_handlers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18239__$1,new cljs.core.Keyword(null,"user-event-handlers","user-event-handlers",-1831736477));
var login_response = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18239__$1,new cljs.core.Keyword(null,"login-response","login-response",844783698));
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"kaleidoscope.ui.pages.admin",null,89,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
