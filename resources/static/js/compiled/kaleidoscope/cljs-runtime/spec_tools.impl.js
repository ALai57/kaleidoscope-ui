...
var vec__18813 = cljs.core.rest(expr);
...
var vec__18816 = first__18815;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18816,(0),null);
var form = seq__18814__$1;
...
var G__18819 = x;
var G__18819__$1 = (((G__18819 == null))?null:spec_tools.impl.polish(G__18819));
var G__18819__$2 = (((G__18819__$1 == null))?null:cljs.core.name(G__18819__$1));
if((G__18819__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__18819__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__18820 = x;
var G__18820__$1 = (((G__18820 == null))?null:cljs.core.name(G__18820));
if((G__18820__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__18820__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__18821){
var map__18822 = p__18821;
var map__18822__$1 = cljs.core.__destructure_map(map__18822);
var data = map__18822__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18822__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18822__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18822__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18822__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__18823){
var map__18824 = p__18823;
var map__18824__$1 = cljs.core.__destructure_map(map__18824);
var data = map__18824__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18824__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18824__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__18825 = data;
var G__18825__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__18825,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__18825);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__18825__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__18825__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__18829 = form;
var G__18829__$1 = (((G__18829 == null))?null:cljs.core.rest(G__18829));
if((G__18829__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__18829__$1);
}
})();
var G__18830 = m;
var G__18830__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__18830,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__18826_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__18826_SHARP_)));
})):G__18830);
var G__18830__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__18830__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__18827_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__18827_SHARP_)));
})):G__18830__$1);
var G__18830__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__18830__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__18828_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__18828_SHARP_));
})):G__18830__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__18830__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__18831 = (function (){var G__18832 = form;
var G__18832__$1 = (((G__18832 == null))?null:cljs.core.rest(G__18832));
if((G__18832__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__18832__$1);
}
})();
var map__18831__$1 = cljs.core.__destructure_map(map__18831);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18831__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18831__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18831__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18831__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__18833 = (function (){var and__5043__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__18835 = form;
var G__18835__$1 = (((G__18835 == null))?null:cljs.core.seq(G__18835));
var G__18835__$2 = (((G__18835__$1 == null))?null:cljs.core.first(G__18835__$1));
if((G__18835__$2 == null)){
return null;
} else {
var fexpr__18840 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__18840.cljs$core$IFn$_invoke$arity$1 ? fexpr__18840.cljs$core$IFn$_invoke$arity$1(G__18835__$2) : fexpr__18840.call(null,G__18835__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq18844){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq18844));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__18845){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__18851){
var map__18852 = p__18851;
var map__18852__$1 = cljs.core.__destructure_map(map__18852);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18852__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18852__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18852__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18852__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__18849_SHARP_){
return cljs.core.map_QMARK_(p1__18849_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__18850_SHARP_){
return cljs.core.contains_QMARK_(p1__18850_SHARP_,x);
});
}),req_keys));
