(ns kaleidoscope.cljs.views
  (:require [kaleidoscope.cljs.pages.admin           :as page.admin]
            [kaleidoscope.cljs.pages.article-page    :as page.article]
            [kaleidoscope.cljs.pages.home            :as page.home]
            [kaleidoscope.cljs.pages.groups          :as page.groups]
            [kaleidoscope.cljs.pages.manager         :as page.manager]
            [kaleidoscope.cljs.pages.article-manager :as page.article-manager]
            [kaleidoscope.cljs.components.loading-screen :as loading]
...
(def panels {:home            page.home/home
             ...
             :editor          (u/lazy-component (lazy/loadable kaleidoscope.cljs.pages.article-editor/editor-ui))})
