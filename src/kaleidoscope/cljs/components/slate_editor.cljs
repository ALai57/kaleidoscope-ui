(ns kaleidoscope.cljs.components.slate-editor
  (:require [kaleidoscope.cljs.article-cards :as article-cards]
            [kaleidoscope.cljs.navbar :as navbar]
            [kaleidoscope.cljs.components.article-selector :as article-selector]
            [kaleidoscope.cljs.components.slate.serialization :as serialization]
            [kaleidoscope.cljs.components.slate.prism :as prism]
            [kaleidoscope.cljs.components.slate.code-block-helpers :as cb]
            [kaleidoscope.cljs.modal :refer [modal-template MODAL-BACKGROUND]]
            [kaleidoscope.cljs.core-api.user :as user]
